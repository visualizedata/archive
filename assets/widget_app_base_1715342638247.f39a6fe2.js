!(function (e) {
  ...
  function u(e, t) {
    e.state_ === m && ((e.state_ = b), (e.data_ = t), n(c, e))
  }
  function l(e, t) {
    e.state_ === m && ((e.state_ = b), (e.data_ = t), n(p, e))
  }
  function d(e) {
    var t = e.then_
    e.then_ = void 0
  ...
  'undefined' != typeof exports && exports
    ? ((exports.Promise = g ? f : y), (exports.Polyfill = y))
  ...
  (function () {
    function e(e, t) {
      if (null == window[i].ContextHolder.lib[e])
        window[i].ContextHolder.lib[e] = null != t ? t : { name: e }
      else if (null != t) return
      return window[i].ContextHolder.lib[e]
    }
    function t(t) {
      return null != window[i].ContextHolder.lib[t]
        ? window[i].ContextHolder.lib[t]
        : e(t, null)
    }
...
!(function () {
  ...
  function t(e, t) {
    void 0 === t && (t = 0), (e = '' + (e || ''))
    for (
      var i = 3735928559 ^ t, n = 1103547991 ^ t, r = 0, a = void 0;
      r < e.length;
      r++
    )
      (a = e.charCodeAt(r)),
        (i = Math.imul(i ^ a, 2654435761)),
  ...
  function n(e) {
    ...
    return Object.keys(i).reduce(function (n, r) {
      var a = i[r],
        o = e.getAttribute ? e.getAttribute(a) : ''
      return e.hasAttribute && e.hasAttribute(a) && '' !== o
        ? n + ';' + r + ':' + t(o)
        : n
    }, '|' + n)
  }
  ...
  function a(e, t) {
    ...
    ;(i.innerHTML = e),
      i.classList.add('uw-page-structure-modal'),
      i.setAttribute('data-uw-feature-ignore', 'true'),
      (i.id = 'uwPageStructureModal'),
      t.isMobile &&
        i.firstChild &&
        i.firstChild.classList.add('uw-ps-mobile')
    var n = document.querySelector('.uw-s10-reading-guide')
    n && n.parentElement && n.parentElement.insertBefore(i, n)
  }
  function o(e, t, i, n) {
    n
      ? (e.settings[t].value[n] = i)
      : 'object' == typeof e.settings[t]
      ? (e.settings[t].value = i)
      : (e.settings[t] = i),
      e.supportsLocalStorage ? window.localStorage.setItem(t, i) : c(t, i)
  }
  function s(e, t, i) {
  ...
  function l() {
    try {
      return (
        ...
        -1 !==
          window.localStorage.setItem.toString().indexOf('[native code]')
      )
    } catch (e) {
      return !1
    }
  ...
  function p(e, t) {
    for (var i = 0; i < t.length; i++)
      for (var n = 0; n < e.length; n++)
        if (t[i].match(new RegExp('^' + e[n] + '$'))) return !0
    return !1
  }
  function y(e, t, i) {
    return 1 - (0.299 * e + 0.587 * t + 0.114 * i) / 255 < 0.5
  }
  function f() {
    return -1 !=
  ...
  function m(e, t) {
    ...
    ;(e.isUserWay = !0),
      ...
      i.forEach(function (t) {
        ...
        if (!i || 'function' != typeof i.postMessage)
          try {
            ;(i = document.querySelector('iframe[name=' + t + ']')),
              (i = i ? i.contentWindow : null)
          } catch (e) {}
        i && i.postMessage(e, '*')
      })
  }
  ...
  function L(e, t, i) {
    if (Array.isArray(t) && 0 !== t.length)
      try {
        i.push(e(t[0])), L(e, t.slice(1), i)
      } catch (n) {
        return L(e, t.slice(1), i)
      }
    return i
  }
  function A(e) {
  ...
  function S() {
    ...
    var i = e.filter(function (e) {
      return (
        -1 ===
          ['userway_iframe_aria_editor', 'uwif'].indexOf(e.className) &&
        !A(e)
      )
    })
    return L(
  ...
  function T(e, t, i, n) {
    var r = void 0,
      a = document.body || document.head
    ;(r = document.createElement('script')),
      (r.onload = function () {
        t && t()
      }),
      (r.src = e),
      i && i.charset && (r.charset = i.charset),
      i && i.id && (r.id = i.id),
      n && ((r.crossOrigin = 'anonymous'), (r.integrity = n)),
      a.appendChild(r)
  }
  function W(e, t, i) {
  ...
  function I(e) {
    ...
    try {
      var i = new URL(e)
      if (!['http:', 'https:'].includes(i.protocol)) return !1
      return (
        /^(https:\/\/)(?:qa\.|api\.qa\.|cdn\.dev\.|cdn\.qa\.|cdn77\.api\.qa\.|manage\.qa\.|api\.|cdn\.|cdn77\.api\.|manage\.|)?userway\.(org|dev)(\/api\/|\/)?/.test(
          i.origin
        ) || i.origin === t
      )
    } catch (e) {
    ...
    if (I(e)) {
      ...
      i.endsWith('.pdf') &&
        (function (e, t, i) {
          ...
          n.open('get', e, !0),
            i.responseType && (n.responseType = i.responseType),
    ...
    var t,
      i = function (e) {
        return (
          ...
          e.hasAttribute('matinput')
        )
      }
    return {
      materialInputLabelContainer:
        i(
          null === e || void 0 === e ? void 0 : e.previousElementSibling
        ) && e,
      materialInputLabelContainerDescendants:
        i(
          null ===
            (t = null === e || void 0 === e ? void 0 : e.parentElement) ||
            void 0 === t
            ? void 0
  ...
  var M = 'https://cdn.userway.org/',
    P = window.UserWayWidgetApp.addLib('util'),
    R = 'data-uw-iframe-ignore',
    F = window.UserWayWidgetApp.getLib('message-stream'),
  ...
  ;(P.firedEvents = {}),
    (P.LIFE_CYCLE_EVENT = {
      ...
      REMEDIATION_IMAGE_ALT_FINISHED:
        'userway:remediation_image_alt_finished',
      REMEDIATION_CSR_LOADED: 'userway:remediation_csr_loaded',
    }),
    (P.PROCESSING_EVENT = {
      REMEDIATION_FORCE_RERUN: 'userway:remediation_force_rerun',
    }),
    (P.DELAYS = { SHORT: 100, MEDIUM: 500, LONG: 1e3 })
  var H = ['STYLE', 'SCRIPT', 'NOSCRIPT', 'TEMPLATE']
  P.supportsPassive = !1
  try {
  ...
  ;(P.init = e),
    (P.isSafari = /^((?!chrome|android).)*safari/i.test(
      navigator.userAgent
    )),
    (P.iOSMobile = /(iphone|ipod|ipad).* os /.test(
      navigator.userAgent.toLowerCase()
    )),
    (P.isChromeExtensionEnv = function () {
      return (
        'object' == typeof chrome && 'object' == typeof chrome.extension
      )
    }),
          ...
          r =
            ...
            -1 !==
              [
                ...
                'TRACE',
                'PATCH',
              ].indexOf(e.method.toUpperCase())
              ? e.method.toUpperCase()
              : 'GET'
        e.body &&
          'GET' === r &&
          Object.keys(e.body).forEach(function (t, i) {
            e.url =
              0 === i
                ? e.url + '?' + t + '=' + e.body[t]
                : e.url + '&' + t + '=' + e.body[t]
    ...
    (P.customTextContent = function (e, t) {
      void 0 === t && (t = 3)
      var i = function (e, t) {
        if (t < 1) return ''
    ...
    (P.xpath = function e(t, i) {
      if ((void 0 === i && (i = !1), t === document.documentElement))
        return '/HTML'
      if (t === document.body) return '/HTML/BODY'
      if (t === document.head) return '/HTML/HEAD'
      for (
        var r = 0,
          a = t.parentNode ? t.parentNode.childNodes : [],
          o = t,
          s = 0;
        o && o.tagName;
      ...
      for (var u = 0; u < a.length; u++) {
        ...
        1 === l.nodeType && l.tagName === t.tagName && r++,
          l.nodeType === Node.TEXT_NODE &&
            t.nodeType === Node.TEXT_NODE &&
            r++
      }
    }),
    (P.visible = function (e) {
    ...
    (P.addPageStructureModal = a),
    (P.setProperty = o),
    (P.removeProperty = function (e, t) {
      delete e.settings[t],
        e.supportsLocalStorage && window.localStorage.removeItem(t)
    }),
    (P.getProperty = s),
    (P.generateRandomId = u),
    (P.supportsLocalStorage = l),
    (P.getCookie = d),
    (P.setCookie = c),
    (P.someInArray = p),
    (P.colourIsLight = y),
    (P.detectBrowser = f),
    (P.isMobile = g),
    (P.isLightHouse = function () {
      return navigator.userAgent.match(/lighthouse/i)
    }),
    (P.getHref = w),
    (P.postMessage = m),
    (P.postMessageWithNotification = function (e, t, i) {
      var n = function (e) {
          var a = e.data || {}
          a.isUserWay &&
            a.action === t &&
            (r(), i(a), window.removeEventListener('message', n))
        },
        r = (function (e, t) {
          void 0 === t && (t = 10)
          var i = !1,
    ...
    (P.assertPostMessageOriginAllowed = function (e) {
      return !!e && (0 === M.indexOf(e) || e === window.location.origin)
    }),
    (P.registerPostMessageListener = function (e) {
      var t = function (t) {
        var i = t.origin.replace('localhost', '127.0.0.1')
        P.assertPostMessageOriginAllowed(i) && e(t)
      }
      return (
    ...
    (P.isElementNode = b),
    (P.isHideFromReaders = h),
    (P.isChecked = v),
    (P.isRequiredElement = x),
    (P.mergeObjects = function (e) {
    ...
    (P.instantiateTreeWalker = function (e, t) {
      function i() {
      ...
      if (
        ...
        var r = i
        ;(r.acceptNode = i),
          (n = t.createTreeWalker(e, NodeFilter.SHOW_TEXT, r, !1))
      } else n = t.createTreeWalker(e, NodeFilter.SHOW_TEXT, null)
      return n
    }),
    (P.getIframes = S),
    (P.hasTextContent = function (e) {
      var t = P.customTrim(e.textContent)
      if (t && t.length) {
        var i = e.parentNode
        if (i && -1 === H.indexOf(i.nodeName.toUpperCase())) return !0
      }
      return !1
    }),
    (P.addUwStylesheetMetropolisFont = function (e) {
      return k(
        'uw-stylesheet-metro',
        P.isChromeExtensionEnv()
          ? chrome.extension.getURL('metropolis.css')
          : e.cdn + 'widgetapp/bundles/metropolis/metropolis.css'
      )
    }),
    (P.addUwStylesheetUDFFont = function (e) {
      return k(
        'uw-stylesheet-udf',
        e.cdn + 'widgetapp/bundles/udf/udf.css'
      )
    }),
    (P.loadDeferredJs = function (e, t, i, n, r) {
      function a() {
        ;(o = !0), t()
      }
      var o = !1
    ...
    (P.scrollToElementWithOffset = function (e, t, i) {
      void 0 === t && (t = null),
        void 0 === i && (i = 10),
        e.classList.contains('screen-reader-text') || W(e, t, i)
    }),
    (P.scrollToElement = W),
    (P.findLabelForControlElement = function (e) {
      function t(e) {
      ...
      if (r) {
        try {
          for (
            var o = __values(r.childNodes), s = o.next();
            !s.done;
            s = o.next()
          ) {
            var u = s.value
            u.nodeType === Node.TEXT_NODE && (a += u.textContent)
          }
        } catch (e) {
          i = { error: e }
        } finally {
      ...
      if (e.getAttribute('aria-labelledby'))
        return P.getLabelledByElements(e.getAttribute('aria-labelledby'))
      if (e.id) {
        var l = (function (e) {
          for (
            var t = document.querySelectorAll('LABEL'), i = 0;
            i < t.length;
            i++
          )
        ...
        if (l) return P.composeElementTextRepresentation(l, '')
      }
      return e.getAttribute('title')
        ? e.getAttribute('title')
        : P.composeElementTextRepresentation(e, '') || ''
    }),
    (P.getLabelledByElements = function (e) {
      for (var t = e.split(' '), i = '', n = 0; n < t.length; n++) {
        var r = document.getElementById(t[n])
        r && (i = ' ' + P.composeElementTextRepresentation(r, i))
      }
      return i
    }),
    (P.composeElementTextRepresentation = function (e, t) {
      function i(e) {
        for (var n = 0; n < e.length; n++) {
          var r = e[n]
          if (r.nodeType !== Node.COMMENT_NODE)
            if (r.nodeType === Node.TEXT_NODE)
              ...
              if (
                ...
                continue
              if (P.isHideFromReaders(r)) continue
              var a = r.getAttribute('aria-hidden'),
              ...
              if (!a || 'false' === a) {
                ...
                o && (t += o + ' '), 'IMG' !== r.tagName && i(r.childNodes)
              }
            }
        }
      }
    ...
    (P.extractChildTextNodes = function (e, t) {
      void 0 === t && (t = '')
      var i = e.childNodes
      return (
        __spreadArray([], __read(i), !1)
          .filter(function (e) {
    ...
    (P.getParents = function (e) {
      return 'BODY' === e.nodeName
        ? [e]
        : arguments.callee(e.parentElement).concat(e)
    }),
    (P.isFirstAboveSecond = function (e, t, n) {
      if ((null == n && (n = 0), e[n] === t[n]))
        return null != e[i] && arguments.callee(e, t, n + 1)
      var r = e[n] ? indow.getComputedStyle(e[n]).zIndex : 'auto',
        a = t[n] ? window.getComputedStyle(t[n]).zIndex : 'auto'
      return r === a
        ? arguments.callee(e, t, n + 1)
        : ('auto' === r ? -0.5 : +r) > ('auto' === a ? -0.5 : +a)
    })
  P.getUserWayIconElementTitle = function (e) {
    return (
      (0,
      window.UserWayWidgetApp.getLib('localization_manager').translate)(
        e.language,
        'widget.html_title'
      ) || 'Accessibility Menu'
    )
  }
  ;(P.getUserWayLstIconElementTitle = function (e) {
    return (
      (0,
      window.UserWayWidgetApp.getLib('localization_manager').translate)(
        e.language,
        'widget.html_lst_title'
      ) || 'Translations Menu'
    )
  }),
    (P.getModalCompanyLogoSource = function (e) {
      var t = e.cdn + 'widgetapp/images/logo-grey.svg',
        i = (function (e) {
          return (
            'https://userway.org?utm_source=' +
            e +
            '&utm_medium=page_structure&utm_campaign=widget'
          )
        })(e.tunings.site_name)
      return (
        e.services &&
        e.services.CUSTOM_BRANDING &&
        e.services.CUSTOM_BRANDING.custom_logo_image_path
          ? ((t = e.services.CUSTOM_BRANDING.custom_logo_image_path),
            (i = e.services.CUSTOM_BRANDING.custom_logo_image_link))
          : e.services &&
            e.services.WHITE_LABEL &&
            e.services.WHITE_LABEL.hide_logo &&
            ((t = ''), (i = '')),
        { src: t, url: i }
      )
    }),
    (P.hexToRgb = function (e) {
    ...
    (P.fireForceRemediationRerunEvent = function () {
      P.fireUserWayLifeCycleEvent(
        P.PROCESSING_EVENT.REMEDIATION_FORCE_RERUN
      )
    }),
    (P.fireUserWayRemediationCompletedEvent = function (e) {
      P.fireUserWayLifeCycleEvent(P.LIFE_CYCLE_EVENT.REMEDIATION, e)
    }),
    (P.fireUserWayLifeCycleEvent = function (e, t) {
      void 0 === t && (t = null), (P.firedEvents[e] = t)
      var i = { userWayInstance: window.UserWay }
      t && (i = P.mergeObjects([i, t]))
      try {
        var n,
          r = P.detectBrowser()
        'ie' === r
    ...
    (P.isInView = function (e) {
      var t = e.getBoundingClientRect()
      return (
        t.top >= 0 &&
        t.left >= 0 &&
        t.bottom <= document.body.getBoundingClientRect().bottom &&
        t.right <= document.body.getBoundingClientRect().right
      )
    }),
    (P.isPartOfElementInViewport = function (e) {
      for (
        var t = e.offsetTop,
          i = e.offsetLeft,
          n = e.offsetWidth,
    ...
    (P.containsInnerText = function (e) {
      return !!e.innerText
    }),
    (P.validateElementAccessibility = function (e) {
      return P.isElementVisible(e) && P.containsInnerText(e)
    }),
    (P.addScreenRearedElement = function (e, t, i) {
      void 0 === i && (i = '')
      ...
      return (
        ...
        n.setAttribute('data-uw-rm-ignore', ''),
        e.appendChild(n),
        n
      )
    }),
    ...
    (P.getDiffPercentage = function (e, t) {
      return (Math.abs(e - t) / ((e + t) / 2)) * 100
    }),
    (P.getStyles = function (e) {
      return e ? window.getComputedStyle(e) : {}
    }),
    (P.isTransparentElement = function (e) {
      var t = P.getStyles(e),
        i = t.background,
        n = t.opacity
      return /(^(rgb\())|(^(:?rgba).*(:?255\))$)/.test(i) || '1' !== n
    }),
    (P.isNotDefaultCssFlow = function (e, t) {
      void 0 === t && (t = ['absolute', 'fixed'])
      var i = P.getStyles(e).position
      return t.includes(i)
    }),
    (P.isOverlayElement = function (e, t) {
      var i = P.getViewport(),
        n = i.vw,
        r = i.vh,
        a = e.offsetWidth,
        o = e.offsetHeight,
        s = P.getDiffPercentage(n, a),
        u = P.getDiffPercentage(r, o)
      if (s > 25 && u > 25) {
        return (
          [].slice.call(e.getElementsByTagName('*')).forEach(function (e) {
            e.matches(t.join(',')) ||
              e.setAttribute('data-uw-feature-ignore', 'true')
          }),
          !0
        )
      }
    ...
    (P.ignoreMaterialUI = function (e) {
      var t = N(e),
        i = t.materialInputLabelContainer,
        n = t.materialInputLabelContainerDescendants
      return (
        !(!i && !n) &&
        (i && i.setAttribute('data-uw-feature-ignore', 'true'), !0)
      )
    }),
    (P.filterTransparentPositionedElements = function (e, t) {
      void 0 === t && (t = [])
      var i = e.matches(t.join(',')),
        n = window.getComputedStyle(e),
        r = 'fixed' === n.position,
        a = P.isNotDefaultCssFlow(e) && !P.isTransparentElement(e) && !i
      return (
        !!P.ignoreMaterialUI(e) ||
        (a &&
          (r
            ? e.setAttribute('data-uw-feature-ignore', 'true')
            : (a = P.isOverlayElement(e, t))),
        !a)
      )
    }),
    ...
    (P.filterIgnoredElems = function (e) {
      return !e.hasAttribute('data-uw-feature-ignore')
    }),
    (P.isOpenShadowRoot = function (e) {
      if (e) return !!e.shadowRoot
    }),
    (P.isOpenShadowNode = function (e) {
      if (e) return e.getRootNode() instanceof ShadowRoot
    }),
    (P.removeFeatureStyles = function (e) {
      var t = e.element,
        i = e.activeCssClass,
        n = e.key,
        r = e.inlineStyles
      t.classList.remove(i), D.resetInlineStyles(t, n, r)
    }),
    (P.getShadowRootChildren = function (e, t) {
    ...
    (P.execForDocumentAndIframes = O),
    (P.isValidUrl = I),
    (P.openUrl = U),
    (P.downloadPdfFile = C),
    (P.hasParentWithAttribute = function (e, t) {
      var i,
        n,
        r = document.querySelectorAll('[' + t + ']')
      try {
        for (var a = __values(r), o = a.next(); !o.done; o = a.next()) {
          var s = o.value
    ...
    (P.formatLangCode = function (e) {
      return (
        e &&
        e.replace(/(^\w+)([-|_|,])(\w+$)/, function (e, t, i, n) {
          return t.toLowerCase() + i + n.toUpperCase()
        })
      )
    }),
    (P.onElementVisible = function (e, t) {
...
var LS_KEY = 'uw-icon-locales',
  ...
  LOCALES = 'widgetapp/2024-05-10-12-03-58/locales/',
  VERSION = '2024-05-10-12-03-58'
!(function () {
  function e(e) {
    var t = i()
    return t && t[e]
  ...
  function i() {
    ...
    return t.version !== VERSION
      ? (window.localStorage.removeItem(LS_KEY), null)
      : t
  }
  function n(e, t) {
    var n = i() || { version: VERSION }
    ;(n[e] = t), window.localStorage.setItem(LS_KEY, JSON.stringify(n))
  }
  var r = UserWayWidgetApp.getLib('util'),
    a = UserWayWidgetApp.addLib('localization_manager')
  Object.assign(a, { initializeLocale: e, translate: t })
})()
var __values =
  (this && this.__values) ||
  function (e) {
...
!(function () {
  ...
  function t(e, t, i) {
    return (
      ...
      e
        .reduce(function (e, n) {
          var r = i && n.position ? ':nth-of-type(' + n.position + ')' : ''
          return (e += n.tag + r + (n.idx >= t ? '>' : ' '))
        }, '')
        .slice(0, -1)
    )
  }
  function i(e, i) {
    ...
    for (var c = [l.Strict, l.Medium, l.Loose], p = 0; p < c.length; p++) {
      var y = (function (u) {
        var c
        for (a = e.length - d - i; a >= 0; a--) {
          r =
            u === l.Loose
              ? t(
                  (c = e.slice(0, 2)).concat.apply(
                    c,
                    __spreadArray([], __read(e.slice(-a - i)), !1)
                  ),
                  e.length - i
                )
              : t(e, e.length - i - a - 1, u === l.Strict)
          var p = n(r, s, o)
          if (p) return p
        }
      })(c[p])
  ...
  function r(e, t) {
    ...
    var n = e.hasAttribute('href')
      ? u.hashString(e.getAttribute('href')).toString()
      : ''
    if (t.href && t.href !== n) return !1
    var r = e.hasAttribute('src')
      ? u.hashString(e.getAttribute('src')).toString()
      : ''
  ...
  (function () {
    ...
    function r(e) {
      return (
        'function' == typeof e ||
        e instanceof RegExp ||
        (!(!e || 'object' != typeof e) && r(e.listener))
      )
    }
    function a(e, i) {
      if (!r(i)) throw new TypeError('listener must be a function')
      var n,
      ...
      for (n in a)
        a.hasOwnProperty(n) &&
          -1 === t(a[n], i) &&
          a[n].push(o ? i : { listener: i, once: !1 })
      return this
    }
    function o(e, i) {
      var n,
        ...
        a = this.getListenersAsObject(e)
      for (r in a)
        a.hasOwnProperty(r) && -1 !== (n = t(a[r], i)) && a[r].splice(n, 1)
      return this
    }
    function s(e, t) {
      var i,
      ...
      for (a in o)
        if (o.hasOwnProperty(a))
          for (i = o[a].slice(0), r = 0; r < i.length; r++)
            (n = i[r]),
      ...
      var e,
        ...
        u =
          null !==
            (a = Number(
              null ===
                (e = null === s || void 0 === s ? void 0 : s.tunings) ||
                void 0 === e
                ? void 0
                : e.tech_do_throttle_ms
            )) && void 0 !== a
            ? a
            : 250,
        l = [],
        ...
        c = function () {
          if (!o) {
            var e = function () {
              ;(l = []), (d = []), clearTimeout(o), (o = null)
            }
            o = setTimeout(function () {
              try {
                n.emitEvent(i.DOM_OBSERVER_DOM_CHANGED_EVENT, [
                  window[t].ContextHolder.config,
                  l,
                  d,
                ]),
                  e()
        ...
        p = function (e, t) {
          for (var i = 0; i < e.length; i++) {
            var n = e[i]
            if ('childList' === n.type) {
              var r = [].slice.call(n.addedNodes).filter(function (e) {
                  return (
                    -1 === ['SCRIPT', 'STYLE'].indexOf(e.tagName) &&
                    'function' == typeof e.hasAttribute &&
                    !e.hasAttribute('data-uw-rm-ignore')
                  )
                }),
                a = [].slice.call(n.removedNodes).filter(function (e) {
                  return (
                    -1 === ['SCRIPT', 'STYLE'].indexOf(e.tagName) &&
                    'function' == typeof e.hasAttribute &&
                    !e.hasAttribute('data-uw-rm-ignore')
...
!(function () {
  ...
  function t(e) {
    var t,
      ...
      a = n
        ...
        .map(function (e) {
          return r.instantiateTreeWalker(e.body, e)
        }),
      o = new Set(),
      s = new Set(),
      u = [],
      c = r.instantiateTreeWalker(e)
    if (null === e || void 0 === e ? void 0 : e.documentElement)
      try {
        for (
          var p = __values(e.documentElement.querySelectorAll('*')),
            y = p.next();
          !y.done;
          y = p.next()
        ) {
          var f = y.value
          r.isOpenShadowRoot(f) &&
            u.push(r.instantiateTreeWalker(f.shadowRoot))
        }
      } catch (e) {
        t = { error: e }
      } finally {
    ...
    return (
      a.splice.apply(a, __spreadArray([0, 0, c], __read(u), !1)),
      a.forEach(function (e) {
        for (var t = e.nextNode(); t; ) {
          if (r.hasTextContent(t)) {
            var i = t.parentNode
            i && o.add(i), s.add(t)
          }
          t = e.nextNode()
      ...
      r.execForDocumentAndIframes(function () {
        ...
        ;[].forEach.call(e, function (e) {
          ...
          ;(d.includes(t) || l.includes(i) || ('input' === i && !t)) &&
            o.add(e)
        })
      }),
      {
  ...
  var i = UserWayWidgetApp.getLib('event_emitter'),
    ...
    a = n.DOM_OBSERVER_DOM_CHANGED_EVENT,
    o = !0,
  ...
  ;(u.init = function () {
    ...
    (u.getElementsWithText = function (e, i) {
      if ((void 0 === i && (i = !0), i && s.elementsWithText))
        return s.elementsWithText
      if (!o) return s.elementsWithText
      var n = t(e),
        r = n.textNodes,
        a = n.elementsWithText
      return (o = !1), (s = { textNodes: r, elementsWithText: a }), a
    }),
    (u.getTextNodes = function (e, i) {
      ...
      var n = t(e),
        r = n.textNodes,
        a = n.elementsWithText
      return (o = !1), (s = { textNodes: r, elementsWithText: a }), r
    })
    ...
    function e() {
      ...
      if ('undefined' == typeof _userway_config || !_userway_config) {
        ...
        if (
          ...
          t &&
            t.hasAttribute('data-account') &&
            (window._userway_config.account =
              t.getAttribute('data-account')),
          !t || !window._userway_config.account)
        ) {
          for (
            var i = document.querySelectorAll('script'), n = 0;
            n < i.length;
            n++
          ) {
            if (
                ...
                if (
                  [
                    ...
                    return (
                      !!i[e].src &&
                      -1 !== i[e].src.indexOf(t) &&
                      (-1 !== i[e].src.indexOf('/widget.js') ||
                        -1 !== i[e].src.indexOf('/widget-i.js'))
                    )
                  }).length > 0
                )
                  return (t = i[e]), 'break'
          ...
          if (t) {
            for (var a = t.attributes, n = a.length; n--; ) {
              var o = a[n],
                s =
                  0 === o.name.indexOf('data')
                    ? o.name.replace(/(^data-)/i, '')
                    : o.name
              s &&
                e.indexOf(s) > -1 &&
                ('type' !== s ||
                  ['1', '2', '3', '4'].indexOf(o.value) > -1) &&
                (window._userway_config[s] = o.value)
            }
            if (!window._userway_config.account)
              for (
                var u = t.src, l = u.split('?').pop().split('&'), d = 0;
                d < l.length;
                d++
              ) {
                var c = l[d].split('=')
                'platfAppInstalledSiteId' === c[0] && c[1]
                  ? (window._userway_config.platfAppInstalledSiteId = c[1])
                  : e.indexOf(c[0]) > -1 &&
                    c[1] &&
                    (window._userway_config[c[0]] = c[1])
              }
          }
        }
      }
      ...
      function i() {
        ...
        return (
          [
            ...
            21, 23, 24, 25, 101, 102, 103, 104, 105, 106, 107, 108,
          ].forEach(function (t) {
  ...
  (function () {
    function e(e) {
      ...
      return t || ((t = new o(e)), r.push(t)), t
    }
    function t(t, i, n) {
      try {
        var r = e(t)
        r.applyStyles(n, i),
          r.element.setAttribute('data-' + i + '-styled', !0)
      } catch (e) {
        !!console.log &&
          console.log('applyInlineStyles error. Element: ' + t)
      }
    }
    function i(t, i, n) {
      try {
        var r = e(t)
        r.resetStyles(n, i),
          r.element.removeAttribute('data-' + i + '-styled')
      } catch (e) {
        !!console.log &&
          console.log('resetInlineStyles error. Element: ' + t)
      }
    }
      ...
      contrast: {
        dark: {
          ...
          forATag: {
            ...
            'border-color': '#ffffff',
            'color': '#fcff3c',
            'svg': { 'background-color': '#000000', 'fill': '#fcff3c' },
          },
          normal: {
            'background-color': '#000000',
            'border-color': '#ffffff',
        ...
        light: {
          ...
          forATag: {
            ...
            'border-color': '#000000',
            'color': '#0000D3',
            'svg': { 'background-color': '#ffffff', 'fill': '#0000D3' },
          },
          normal: {
            'background-color': '#ffffff',
            'border-color': '#000000',
    ...
    var r = [],
      ...
      o = (function () {
        ...
        return (
          ...
          (e.prototype.removeStyleFromAppliedStylesByFeature = function (
            e
          ) {
              ...
              e &&
                (Object.keys(e).forEach(function (n) {
                  ;(i.appliedStyles[n] = {
                    ...
                    i.element.style.setProperty(n, e[n], 'important'),
                    i.element.style.setProperty('transition', i.transition)
                }),
                -1 === this.listOfApplyiedStylesKeys.indexOf(t) &&
                  this.addStyleToAppliedListKeys(t))
          }),
          (e.prototype.resetStyles = function (e, t) {
            ...
            Object.keys(e).forEach(function (e) {
              if (
                i.appliedStyles[e] &&
                i.appliedStyles[e].featureThatApply === t
              ) {
                i.element.style.setProperty(
                  ...
                  i.element.style.setProperty(
                    e,
                    void 0 === i.appliedStyles[e].oldValue
                      ? ''
                      : i.appliedStyles[e].oldValue
                  ),
                  delete i.appliedStyles[e]
                if ('background-color' === e || 'background' === e) {
                  var n =
                    (i.initialStyles.background && 'background') ||
                    (i.initialStyles['background-color'] &&
                      'background-color')
                  if (!n) return
                  var r = i.initialStyles[n].split('!')
                  r.length >= 2
                    ? i.element.style.setProperty(
                        n,
                        r[0].trim(),
                    ...
                    : i.element.style.setProperty(n, i.initialStyles[n])
                }
              }
            }),
                  ...
                  if (t) {
                    ...
                    if (
                      ...
                      window.location.pathname ===
                        atob(
                          'L3dwcy9wb3J0YWwvUHJlcGFpZENhcmRTZWxmQ2FyZQ=='
                        ))
                    ) {
                      var r = { 'background-image': 'none' }
                      i.applyStyles(r, atob('dXctcmFrYmFuay1maXg='))
                    }
                  }
                })
          }),
              ...
              case 'userway-s3-3':
                ...
                t =
                  'A' === this.element.tagName
                    ? n.featureStyles.contrast[i].forATag
                    : n.featureStyles.contrast[i].normal
                break
              case 'userway-s6':
                t =
                  'IMG' === this.element.tagName
                    ? n.featureStyles.highlinks.inlineImgStyles
                    : n.featureStyles.highlinks.inlineStyles
                break
              default:
  ...
  (function () {
    function e() {
      ...
      var a = [],
        o = []
      n.emitEvent(i.IS_MOUSE_USER_EVENT, [
        window[t].ContextHolder.config,
        a,
        o,
      ]),
    ...
    var t = 'UserWayWidgetApp',
      ...
      n = window[t].getLib('event_emitter'),
      r = !1
    ;(i.IS_MOUSE_USER_EVENT = 'IS_MOUSE_USER'),
...
!(function () {
  function e() {
    ...
    n.filter(function (e) {
      ...
      (m = n[1]),
      (!w ||
        (g.config.services.MODIFY_MENU &&
          -1 ===
            g.config.services.MODIFY_MENU.features_pattern
              .split('|')
              .indexOf('s11'))) &&
        (n = n.filter(function (e) {
          return e.id !== T.openNavMenu
        }))
    var r = t()
    r.setAttribute(
      'aria-label',
      A(e.language, 'skip_links.title') || 'Quick Accessibility Options'
    ),
      n.forEach(function (e, t) {
        var i = document.createElement('button')
        ;(i.className = 'uw-sl__item'),
          i.setAttribute('data-uw-rm-ignore', 'true'),
          i.setAttribute('data-uw-ignore-translate', 'true'),
          i.setAttribute('lang', e.language),
          (i.id = e.id)
        var n = document.createElement('span')
        ;(n.className = 'uw-sl__item__left'),
        ...
        ;(l.className = 'uw-sl__e-icon'),
          ...
          i.addEventListener('click', function (t) {
            ...
            e.altTitle && (s.innerHTML = n),
              i.setAttribute('aria-label', n),
              i.blur()
          }),
          i.addEventListener('keydown', function (e) {
            ;('Escape' !== e.code && 27 !== e.keyCode && 27 !== e.which) ||
              (i.blur(), o())
          }),
          e.focusHandler && i.addEventListener('focus', e.focusHandler),
          r.appendChild(i)
      })
  }
  function t() {
    ...
    if (!e) {
      ...
      if (t) {
        var i = function (i) {
            ...
            try {
              for (
                var o = __values(i), s = o.next();
                !s.done;
                s = o.next()
              ) {
                var u = s.value
                if ('childList' === u.type) {
                  Array.from(u.removedNodes).find(function (t) {
                    return t == e
                  }) && (t.insertBefore(e, t.firstChild), n.disconnect())
                }
              }
            } catch (e) {
              r = { error: e }
  ...
  function i() {
    var e = g.config,
      t = {
        title:
          A(e.language, 'skip_links.title') ||
          'Quick Accessibility Options',
        skip: A(e.language, 'skip_links.skip') || 'Skip to main content',
        enable_visually_impaired:
          A(e.language, 'skip_links.enable_visually_impaired') ||
          'Enable accessibility for visually impaired',
        disable_visually_impaired:
          A(e.language, 'skip_links.disable_visually_impaired') ||
          'Disable accessibility for visually impaired',
        open_accessibility_menu:
          A(e.language, 'skip_links.open_accessibility_menu') ||
          'Open the accessibility menu',
        open_accessibility_nav:
          A(e.language, 'skip_links.open_accessibility_nav') ||
  ...
  function n() {
    ...
    g.lazyLoad().then(function () {
      g.showPageStructureLinks(e)
    }),
      f(k.PAGE_STRUCTURE)
  }
  function r() {
    g.openWidget(), f(k.OPEN_WIDGET), o()
  }
  function a(e) {
    O || (f(k.OPEN_LINKS), (O = !0)),
      'uw-enable-visibility' === e.target.id && y(),
      setTimeout(function () {
        if (W) return o()
      }, 1)
  }
  ...
  function s() {
    var e = l() || document.querySelector(h)
    e.getAttribute('tabindex') || e.setAttribute('tabindex', '-1'),
      f(k.SKIP_TO_MAIN_CONTENT),
      setTimeout(function () {
  ...
  function u(e) {
    for (
      ...
      t &&
      'BODY' !== t.tagName &&
      (!(i = t.nextElementSibling) || !x.validateElementAccessibility(i));
  ...
  function l() {
    for (var e, t = 0; t <= v.length - 1; t++) {
      ...
      if (
        i &&
        ('[role="main"]' !== v[t] || 'BODY' !== i.tagName) &&
        x.isElementVisible(i)
      ) {
  ...
  function d() {
    return E.ElementsWithText.getElementsWithText(document).find(function (
      e
    ) {
      if (
        (-1 !== e.classList.value.search(/main/) ||
          -1 !== e.classList.value.search(/title/) ||
          -1 !== e.classList.value.search(/header/)) &&
        x.validateElementAccessibility(e) &&
        e.hasAttribute('data-uw-rm-ignore')
      )
        return e
    })
  ...
  function p() {
    if (c()) {
      if (g.isSoundEffectsEnabled())
        try {
          var e = new Audio(g.config.cdn + 'widgetapp/sounds/reset.mp3')
          e.play()
        } catch (e) {}
      x.postMessage({ action: 'updateVisuallyImpairedState', config: !1 })
    } else {
      if (g.isSoundEffectsEnabled())
        try {
          var e = new Audio(
            g.config.cdn + 'widgetapp/sounds/viEnabled.mp3'
          )
          e.play()
        } catch (e) {}
      x.postMessage({ action: 'updateVisuallyImpairedState', config: !0 }),
        setTimeout(function () {
    ...
    f(k.VISUALLY_IMPAIRED)
  }
  function y() {
    var e = document.querySelector(
        '#uw-enable-visibility .uw-sl__item__title[data-uw-rm-ignore]'
      ),
    ...
    t &&
      e &&
      n.altTitle &&
      ((e.innerHTML = c() ? n.altTitle : n.title),
      (e.ariaLabel = c() ? n.altTitle : n.ariaLabel),
      (t.ariaLabel = c() ? n.altTitle : n.ariaLabel))
  }
  function f(e) {
    var t = {
      ...
      state: e,
      uid: g.config.uid,
      type: g.config.services.paidAi ? 'paid' : 'free',
      real: !0,
    }
    atob('eExxdFhtQVRSdw==') !==
      UserWayWidgetApp.ContextHolder.config.account &&
      x
        .request({
          method: 'POST',
          url: S + '/v1/stats/enabled-feature',
          body: t,
  ...
  var g,
    w,
    m,
    b = UserWayWidgetApp.addLib('skip_links'),
    _ = '#uw_skip_to_main_content_anchor',
    h = '#userwayAccessibilityIcon',
    v = [
      'main',
      'h1',
      'nav',
    ...
    L = UserWayWidgetApp.getLib('localization_manager'),
    A = L.translate,
    E = UserWayWidgetApp.getLib('helpers'),
    S = 'https://api.userway.org/api',
    k = {
      OPEN_LINKS: 1,
  ...
  ;(b.insert = function () {
    var t, i
    ;(g = UserWayWidgetApp.addLib('main')),
      (w = g.config.services && g.config.services.paidAi)
    var n = UserWayWidgetApp.getLib('remediationConfig')
      ? UserWayWidgetApp.getLib('remediationConfig').skipLinks
      : null
    ;(null === n || void 0 === n ? void 0 : n.enabled) &&
      ((null === (t = null === n || void 0 === n ? void 0 : n.config) ||
      void 0 === t
        ? void 0
        : t.anchorSelector) &&
        (_ =
          null === (i = null === n || void 0 === n ? void 0 : n.config) ||
          void 0 === i
            ? void 0
            : i.anchorSelector),
      v.unshift(_),
  ...
  (function () {
    var e = UserWayWidgetApp.addLib('scan_manager'),
      ...
      n = 'widgetapp/2024-05-10-12-03-58/scan/scan_1715342638247.js'
    ;(e.run = function () {
      var e = UserWayWidgetApp.ContextHolder.config
      setTimeout(function () {
        if (!e.services || 81434 !== e.services.userId) {
          var r = e.tunings && !!e.tunings.widget_scan_url_params
          if (
            !(
              location.href &&
            ...
            'fetch' in window &&
              ...
              fetch(
                'https://api.userway.org/api/a11y-data/v0/page/' +
                  encodeURIComponent(location.href) +
                  '/' +
                  (t.isMobile() ? 'MOBILE' : 'DESKTOP') +
                  '/' +
                  a +
                  '/status'
              ).then(function (e) {
                try {
                  e.json().then(function (e) {
                    e.payload &&
                      'CONTRIB_MISSING' === e.payload.status &&
                      t
                        .execJs(
                          i + n,
                          'sha256-NQ6ESntthWEvioGfVAROMYiElwPYw6iRWeh3s2ULklc='
                        )
                        .then(function () {
      ...
      (e.accessibilityScore = function () {
        return new Promise(function (e, r) {
          ...
          var a = UserWayWidgetApp.getLib('scan_helper')
          a && 'function' == typeof a.scan
            ? a.scan().then(function (t) {
                e(t)
              })
            : t
                .execJs(
...
!(function () {
          ...
          (null ===
            (i =
              null === (e = t.config) || void 0 === e
                ...
                : e.tunings) || void 0 === i
            ? void 0
            : i.widget_open_hotkey) || 'null'
        )
      return (
        n && (n = n.filter(Boolean)),
        (null === n || void 0 === n ? void 0 : n.length) >= 2
          ? n
          : DEFAULT_OPEN_HOTKEY
      )
    }
  ...
  (function () {
    function e(e, i) {
      if (i.length) {
        if (
          ...
          i[0].id.indexOf('powered_by_pixle') > -1
        )
          return
        t()
      }
                ...
                e.data.forEach(function (e) {
                  ...
                  if (t && t.length) {
                    var i = {
                      ...
                      header: { 'Content-Type': 'application/json' },
                      body: { names: t, site: location.host },
                    }
                    u.request(i)
                  }
                })
    ...
    var r,
      a = UserWayWidgetApp.addLib('cpr_usage_detector'),
    ...
    a.run = function () {
      ...
      ;(r =
        null ===
          (a =
            null === (n = UserWayWidgetApp.ContextHolder) || void 0 === n
              ? void 0
              : n.config) || void 0 === a
          ? void 0
          : a.cpr) && (i(), t(), o.on(s.DOM_OBSERVER_DOM_CHANGED_EVENT, e))
    }
  })(),
  (function () {
    function e(e, i, n, r) {
      void 0 === r && (r = '')
      var a = (e + (r ? '-' + r : '')).toLowerCase(),
        o = function (o) {
          o.some(function (t) {
            var n = t.lang,
              o = t.name,
              s = n.toLowerCase(),
              u = o.includes(i),
              l = r ? s === a : s.startsWith(e.toLowerCase())
            return u && l
          }) && t(e, i, n, r)
        },
        s = function () {
      ...
      try {
        ...
        console.error('Error checking system voices:', e)
      }
    }
    function t(e, t, i, n) {
      c.push({
    ...
    function i(e) {
      ...
      return !!a(
        (null === t || void 0 === t ? void 0 : t.getAttribute('lang')) ||
          (null === t || void 0 === t
            ? void 0
    ...
    function n() {
      var e = document.getElementsByTagName('html')[0],
        t =
          (null === e || void 0 === e ? void 0 : e.getAttribute('lang')) ||
          (null === e || void 0 === e
            ? void 0
            : e.getAttribute('xml:lang')),
        i = a(t)
      i &&
        d.execForDocumentAndIframes(function () {
          ...
          !(
            ...
            (null === e ||
              void 0 === e ||
              e.setAttribute('lang', i.toLocaleStr()))
        })
    }
    function r(e) {
      var t,
      ...
      try {
        ...
        for (
          ...
          r &&
          !(o = a(
            r && 'function' == typeof r.getAttribute
              ? r.getAttribute('lang')
              : null,
            !1
          )) &&
    ...
    function a(e, t) {
      ...
      if (!s && t) {
        ...
        return a(
          (null === u || void 0 === u ? void 0 : u.getAttribute('lang')) ||
            (null === u || void 0 === u
              ? void 0
              : u.getAttribute('xml:lang')) ||
            null,
          !1
        )
      }
    ...
    var u = 'UserWayWidgetApp',
      ...
      c = []
    ;(l.getLocaleForText = a),
      (l.getLocaleForElement = r),
      (l.isAvailableWithPreferedLanguage = i),
      (l.enrichDomWithPreferableLanguage = n),
  ...
  (function () {
    function e(e) {
      var t = void 0 === e ? { pageLanguage: '', widgetLanguage: '' } : e,
        ...
        r = t.widgetLanguage
      return (
        n.isAvailableWithPreferedLanguage(i) &&
        n.isAvailableWithPreferedLanguage(r)
      )
    }
    var t = 'UserWayWidgetApp',
...
!(function () {
  var e = UserWayWidgetApp.getLib('util'),
    t = function () {
      try {
        ...
        return (
          console.warn(
            'Unable to resolve persisted in the local storage language',
            e
          ),
          null
        )
    ...
    i = function () {
      try {
        ...
        console.warn(
          'Unable to resolve language set as hardcoded config in the UserWay embed script',
          e
        )
      }
      return null
    ...
    n = function () {
      try {
        ...
        return (
          userwaySupportedLocales.includes(i) || (i = i.split('-')[0]),
          userwayMapToSupportedLanguages[i] &&
            (i = userwayMapToSupportedLanguages[i]),
          userwaySupports(i) ? i : null
        )
      } catch (e) {
        return (
          console.warn('Unable to parse page html lang attribute', e), null
        )
      }
    },
    r = function (e) {
      return (
        ...
        t() ||
          i() ||
          e.ownerLangSelection ||
          n() ||
          USERWAY_DEFAULT_FALLBACK_LANGUAGE
      )
    },
    a = function (e) {
      void 0 === e && (e = { ownerLangSelection: '' })
  ...
  Object.assign(o, {
    ...
    userLandSelectionIsDefaultLangSelected: a,
  })
})()
var __assign =
  (this && this.__assign) ||
...
!(function () {
  ...
  var r = {
    ...
    a =
      ...
      (e[t.KeyboardUser] = (function (e) {
        ...
        successMatches: 2,
        test: function (e) {
          return [r.isTab, r.isArrowLeft, r.isArrowRight].some(function (
            t
          ) {
            return t(e)
          })
      ...
      e)
  ;(i.start = function () {
    o() || u() || document.addEventListener('keydown', s)
  }),
    (i.stop = function () {
  ...
  var o = function () {
    ...
    s = function (e) {
      var n = a[t.KeyboardUser]
      n.test(e) &&
        (n.addMatch(),
        n.isFullyMatched() && (i.stop(), d(n.flag).then(l).catch(i.start)))
    },
    u = function () {
      try {
...
!(function () {
  function e() {
    _t.initializeConfig().then(function (e) {
      ;(ct = e), (dt.config = ct)
      var t = null
      try {
        t = window.localStorage.getItem(ri)
      } catch (e) {}
      if (!t) {
        t = i()
        try {
          window.localStorage.setItem(ri, t)
        } catch (e) {}
      }
      ;(ct.uid = t), p() ? w() : (Ae(), c())
    })
  ...
  function t() {
    return !!ct && !!ct.tunings && ct.tunings.widget_blocked_for_site
  }
  function i() {
  ...
  function n() {
    return (
      !(!ct || !ct.tunings) &&
      (!0 === ct.tunings.widget_hidden_for_site ||
        (!0 === ct.tunings.widget_hidden_for_mobile && mt.isMobile()))
    )
  }
  function r() {
    return ct.tunings.widget_layout
  }
  function a() {
    var e,
      t = r(),
      i = Boolean(
        null === (e = ct.services) || void 0 === e ? void 0 : e.paidAi
      )
    return ('headless' === t && !i) || !t || 'full' === t
  }
  function o() {
    ;(rt = UserWayWidgetApp.getLib('nano-widget')),
      rt.load().then(function () {
        rt.init()
      })
  }
  function s() {
    ;(at = UserWayWidgetApp.getLib('mini-widget')),
      at.load().then(function () {
        at.init()
      })
  }
  function u() {
    ke(),
      Z(ct),
      mt.addStyleString(qt),
      oe(),
      Ce(),
      ht.initializeDomChangesObserver(),
      kt.init(),
      xt.run(),
      At.run(),
      Lt.start(),
  ...
  function l(e) {
    ;(null === e || void 0 === e ? void 0 : e.enabled) &&
      mt.execJs(
        It + Ft,
        'sha256-onF7gsERV7Q5hzwMa1mPF3Uz6ZMSfkvjjl5w9oAEBMM='
      )
  }
  function d() {
    var e,
      t,
      i = sessionStorage.getItem('qa_widget_lst_button_enabled'),
      r = sessionStorage.getItem('qa_widget_lst_button_type'),
      o = sessionStorage.getItem('qa_widget_lst_button_icon_type')
    if (
      ('true' === i &&
        ((ct.tunings.widget_lst_button_enabled = i),
        (ct.tunings.widget_lst_button_type = r),
        (ct.tunings.widget_lst_button_icon_type = o)),
      n())
    )
      return void oe()
    if (!a()) return u()
    w(),
      ...
      l(ct.statistics),
      Q(
        ct.services.LIVE_TRANSLATIONS,
        null ===
          (t =
            null === (e = ct.remediation) || void 0 === e
              ? void 0
              : e.commonSettings) || void 0 === t
          ? void 0
          : t.enabled
      ),
      mt.addStyleString(qt),
      ...
      oe(),
      ct.tunings &&
        ct.tunings.hasOwnProperty('widget_headless') &&
        !0 === ct.tunings.widget_headless &&
        UserWay.iconVisibilityOff(),
      be(),
      H()
    var s = mt.getProperty(ct, zt),
      d = !mt.isMobile() && ct.tunings.widget_position_nudge,
      c = mt.isMobile() && ct.tunings.widget_position_nudge_mobile
    if ((d || c) && !s)
    ...
    N(),
      O(),
      Ce(),
      mt.isMobile() || vt.insert(),
      V(),
      ne(),
      ue(),
      ae(),
      Me(),
      ct.partner === atob('cmFrYmFuaw==') &&
        window.location.pathname ===
          atob('L3dwcy9wb3J0YWwvUHJlcGFpZENhcmRTZWxmQ2FyZQ==') &&
        document
          .querySelector('#keyboard')
          .setAttribute('data-uw-ignore-translate', !0),
      ht.initializeDomChangesObserver(),
      kt.init(),
      xt.run(),
      At.run(),
    ...
    if (!window._userway) {
      ...
      Le(),
        X(function () {
          if (t())
            return console.warn(
              'UserWay Accessibility widget is deactivated'
            )
          if (
            mt.isMobile() &&
            ct.tunings &&
            ('false' === ct.tunings.mobile || !1 === ct.tunings.mobile)
          )
            console.warn(
              'UserWay Accessibility widget is disabled on mobile devices via tunings setting'
            )
          else
            var e = setInterval(function () {
              document.body && (clearInterval(e), d())
            }, 500)
        })
    }
  }
  function p() {
    return !!mt.getCookie('hidewidget')
  }
  function y() {
    return (
      ct &&
      ct.tunings &&
      ct.tunings.hasOwnProperty('widget_sounds') &&
      ct.tunings.widget_sounds
    )
  }
  function f() {
  ...
  function g(e) {
    ;('Tab' !== e.key && 9 !== e.keyCode && 'ArrowDown' !== e.key) ||
      (UserWayWidgetApp.ContextHolder.config.services.paidAi &&
        UserWayWidgetApp.ContextHolder.remediationModulePromise.then(
          function () {
  ...
  function m() {
    var e,
      t =
        (null === (e = ct.services) || void 0 === e ? void 0 : e.paidAi) ||
        !ct.services.hasOwnProperty('paidAi'),
      i =
        ct.services.hasOwnProperty('MODIFY_MENU') &&
        ct.services.MODIFY_MENU.is_enabled,
      n =
        !i ||
        -1 !==
          ct.services.MODIFY_MENU.features_pattern.split('|').indexOf('s9')
    t &&
      n &&
      Et.isAvailable({
        pageLanguage: ct.widgetPageLang,
        widgetLanguage: ct.language,
      }) &&
  ...
  function _() {
    var e =
        ...
        ct.services.MODIFY_MENU.is_enabled,
      t =
        ct.services.hasOwnProperty('VOICE_NAVIGATION') &&
        ct.services.VOICE_NAVIGATION.is_enabled,
      i = !!window.chrome,
      n = Boolean(navigator.userAgent.match(/safari/i))
    ;(i || n) &&
      t &&
      (!e ||
        !ct.services.MODIFY_MENU.features_pattern
          .split('|')
          .includes('s24')) &&
    ...
    if (!Yt) {
      ...
      var e = function (e) {
        ...
        if (t.isUserWay)
          if ('appConfigLoaded' === t.action)
          ...
          else if ('download_pdf' === t.action) mt.downloadPdfFile(t.url)
          else if ('AiPageReload' === t.action) document.location.reload()
          else if ('openExternalLink' === t.action)
            try {
              if (!mt.isValidUrl(t.url)) return
              mt.openUrl(t.url)
            } catch (e) {
              return
            }
          else if ('getConfig' === t.action) W()
          else if ('isWidgetOpened' === t.action)
            ft
              ? mt.postMessage({ action: 'toggled', state: 'show' })
              : mt.postMessage({ action: 'toggled', state: 'hide' })
          else if ('close' === t.action) ge()
          else if ('open' === t.action) fe()
          else if ('manageIconVisibility' === t.action) le(t.type)
            ...
            t.lang ||
              ...
              window.localStorage.removeItem('userway-selectedSiteLang')
          else if ('on_demand_reader' === t.action) {
            if (
              t.contentToRead &&
              (ct.services.paidAi || !ct.services.hasOwnProperty('paidAi'))
            ) {
              var i = t.menuLanguage
              t.contentWithPageLang && (i = St.resolvePageLangAttribute()),
                He.readTextContent({
                  language: i,
          ...
          } else if ('on_demand_reader_stop' === t.action) He.stopReading()
          else if ('setProperties' === t.action) {
            for (var n in t.settings)
              t.settings.hasOwnProperty(n) &&
                void 0 !== ct.settings[n] &&
                'userway_hidden' !== n &&
                (ct.settings[n].value = t.settings[n].value)
            var r = [
                's101',
                's102',
                's103',
            ...
            a &&
              t.pattern &&
              (ct.services.MODIFY_MENU.features_pattern = t.pattern
                .filter(function (e) {
            ...
            'links' === s
              ? Ke.showPageStructureLinks(o)
              : 'landmarks' === s
              ? Ke.showPageStructureLandmarks(o)
              : Ke.showPageStructureHeaders(o)
          } else if ('setWidgetColor' === t.action)
            (ct.tunings.widget_color = t.color),
              (ct.tunings.widget_color_gradient = t.gradient),
              O(),
              V()
          else if ('setIconType' === t.action)
            (ct.tunings.widget_icon_type = t.iconType), O()
          else if ('setSoundEffects' === t.action)
            ct.tunings.widget_sounds = t.value
          else if ('isVisibleOnMobile' === t.action)
            ct.tunings.widget_hidden_for_mobile = t.value
          else if ('setIconSize' === t.action)
            (ct.tunings.widget_icon_size = t.iconSize), O()
          else if ('setWidgetLanguage' === t.action)
            Re('enable', 'LIVE_TRANSLATIONS'),
              J(t.langCode),
              setTimeout(function () {
                U(), I()
              }),
            ...
            'websiteTranslationCompleted' === t.action ||
            'websiteTranslationReverted' === t.action
          )
            Fe('enable', 'LIVE_TRANSLATIONS'),
              setTimeout(function () {
                U(), H()
              })
            ...
            t.byUser ||
              (t.isMobile
                ? mt.removeProperty(ct, Bt)
                : mt.removeProperty(ct, zt)),
              t.byMoveHideSection ||
                (ct.tunings.widget_position = t.position),
              be(
                t.byUser ? t.position : null,
                !!t.isMobile && t.isMobile,
                t.byMoveHideSection
              ),
              (!mt.isMobile() && t.widget_position_nudge) ||
              (mt.isMobile() && t.widget_position_nudge_mobile)
                ? me(t)
                : h(),
              O()
          else if ('setTimeHideWidget' === t.action) he(t.value)
            ...
            if (je) {
              var l =
                'ie' === ct.browser
                  ...
                  : window.scrollY
              ;(u.yPos = u.yPos + l), je.setRulerElPosition(u)
            }
          } else if ('custom_trigger_update' === t.action) {
            ;(ct.tunings.widget_custom_trigger = t.data.selector),
              (ct.tunings.widget_custom_trigger_enabled = t.data.enabled)
            var d = [].slice.call(
              document.querySelectorAll('[data-uw-trigger="true"]')
            )
            d.forEach(function (e) {
              e.removeEventListener('click', ee),
                e.removeEventListener('keypress', te),
                e.removeAttribute('data-uw-trigger')
            })
            var c = Ne()
            c && c.length
              ? (window.UserWay.iconVisibilityOff(), ie())
              : window.UserWay.iconVisibilityOn()
          } else if ('on_demand_reader_preload' === t.action)
            Re('preload', 'userway-s9'),
              He.preload().then(function () {
                return Fe('preload', 'userway-s9')
              })
          else if ('closeVoiceNavigation' === t.action)
            ve('s24', 0),
              mt.postMessage({ action: 'closeVoiceNavigation' })
          else if ('sendEventToGoogleAnalytics' === t.action) {
            var p = 0 === t.state ? 'disabled' : 'enabled'
            ai(t.name, p)
          }
      }
      mt.registerPostMessageListener(e)
    }
  }
  function x() {
    document
      .querySelectorAll('body > *:not(script):not(.uwy)')
      .forEach(function (e) {
  ...
  function A(e) {
    Tt.isHotkeyToOpenWidget(e) &&
      (e.preventDefault(),
      p()
        ? (mt.setCookie('hidewidget', '', null), window.location.reload())
        : (Ue(), fe()))
  }
  function E(e) {
    ;('Space' !== e.keyCode && 32 !== e.which) ||
      !e.ctrlKey ||
      UserWay.resetAll()
  }
  function S(e) {
    if (
      ...
      var t = window.localStorage.getItem('readerSpeed')
        ? window.localStorage.getItem('readerSpeed')
        : 1
      ;(t = parseInt(t, 10)),
        T(t),
        ct.settings['userway-s9'].value
          ? UserWay.readPageDisable()
          : UserWay.readPageEnable(t),
        mt.postMessage({ action: 'toggleReader' })
    }
  }
  function k(e) {
    var t, i
    if (('Comma' === e.code || ',' === e.key) && e.ctrlKey) {
      var n =
        ...
        (null ===
          (i =
            null ===
              (t = null === ct || void 0 === ct ? void 0 : ct.settings) ||
            void 0 === t
              ? void 0
              : t['userway-s24']) || void 0 === i
          ? void 0
          : i.value)
      Ie().then(function () {
        ve('s24', n ? 0 : 1),
  ...
  function T(e) {
    var t = setInterval(function () {
      if (window.responsiveVoiceLocales) {
        var i =
            window.responsiveVoiceLocales[ct.language].widget
              .responsive_voice,
          n = ct.settings['userway-s9'].value
            ? Pe()
              ? i.enabled_wl
              : i.enabled
            : Pe()
            ? i.disabledScreenReader_wl
            : i.disabledScreenReader
        He.readTextContent({
  ...
  function W() {
    mt.postMessage({ action: 'sendConfig', config: ct })
  }
  function O() {
    var e,
      t,
    ...
    if (
      ct.services.LIVE_TRANSLATIONS &&
      (null === (e = ct.tunings) || void 0 === e
        ? void 0
        : e.widget_lst_button_enabled)
    )
      switch (
        null === (t = ct.tunings) || void 0 === t
          ? void 0
          : t.widget_lst_button_type
      ) {
        case '1':
          M(r, n)
          break
    ...
    C(i, r), I()
    var a = document.querySelector('div.uwy')
    mt.isMobile() || 'small' === n
      ? (a.classList.remove('uts'), a.classList.remove('utb'))
      : ('mini' === n && a.classList.add('uts'),
        'large' === n && a.classList.add('utb'))
  }
  function I() {
    ...
    var e = function () {
        var e,
          ...
          r =
            ...
            (null === (e = ct.tunings) || void 0 === e
              ? void 0
              : e.widget_lst_button_icon_type)
        if (
          null === (t = ct.tunings) ||
          void 0 === t ||
          !t.widget_lst_button_enabled ||
          'flag' !== r
        ) {
          var a = tt.getNameByLangCode(i),
            o = document.createElement('div')
          if (
            (o.classList.add(
              'uwaw-lang-list__circle',
              'uwaw-lang-list__circle-' + st
            ),
            o.setAttribute('data-uw-rm-ignore', ''),
            o.setAttribute('data-uw-ignore-translate', !0),
            o.setAttribute('title', 'Auto Translation enabled: ' + a),
            (o.textContent += st),
            null === (n = ct.tunings) || void 0 === n
              ? void 0
              : n.widget_lst_button_enabled)
          ) {
            var s = document.querySelector('.ulsti .usr')
            s.parentNode.insertBefore(o, s.nextSibling)
          } else {
            var u = document.querySelector('.uai .usr')
        ...
        Promise.all([
          (function () {
            return tt
              ...
              : mt
                  .execJs(
                    It +
                      'frontend/javascripts/languages.js?v=1715342638247',
                    'sha256-LIfvPni5iWYayGR2igdf98r49kDXXejBtKtzbLu7igo='
                  )
                  .then(function () {
                    return (tt = UserWayWidgetApp.getLib('LANGUAGES')), !0
                  })
                  .catch(function () {
                    return !1
                  })
          ...
          (function () {
            return Qt
              ...
              : mt
                  .addStylesheet(
                    It + 'frontend/stylesheets/flags.css?v=1715342638247'
                  )
                  .then(function () {
                    return (Qt = !0)
                  })
          ...
          var n = __read(t, 2),
            ...
            a = n[1]
          if (r && a) {
            ;(st = tt.getIsoByLangCode(i || ct.language)),
              D('hide'),
              i && e()
            M(q(), '' + z())
          }
  ...
  function C(e, t) {
    ...
    try {
      for (var a = __values(r), o = a.next(); !o.done; o = a.next()) {
        ...
        if (s) {
          s.innerHTML =
            '<img width="43" height="43" data-uw-rm-ignore="" class="' +
            (t.isLight ? 'si_b' : 'si_w') +
            '" aria-hidden="true" alt="Spinner: ' +
            (t.isLight ? 'Black' : 'White') +
            ' decorative" src="" />'
          var u = s.querySelector('img.si_w')
          R(t, s.querySelector('img.si_b'), u, 'spin')
        }
      }
    } catch (e) {
      i = { error: e }
  ...
  function N() {
    ...
    if (
      ...
      var n = document.querySelector('.ulsti')
      null === n || void 0 === n || n.classList.add('userway_loading')
    }
  }
  function M(e, t) {
    var i,
      n =
        '' +
        (null === (i = ct.tunings) || void 0 === i
          ? void 0
          : i.widget_lst_button_icon_type),
      r = document.querySelector('.ulsti .uiiw'),
      a = document.querySelector('.ulsti')
    r.innerHTML =
      '<img data-uw-rm-ignore="" class="' +
      (e.isLight ? 'ui_b' : 'ui_w') +
      '" role="presentation" alt="" src="" data-uw-ignore-s25/>'
    var o = document.querySelector('.ulsti img.ui_w'),
      s = document.querySelector('.ulsti img.ui_b')
    switch (n) {
      case 'characters':
        R(e, s, o, 'characters'),
          s && s.setAttribute('alt', ''),
          o && o.setAttribute('alt', '')
        break
      case 'earth':
        R(e, s, o, 'earth'),
          s && s.setAttribute('alt', ''),
      ...
      case 'flag':
        if (((r.innerHTML = ''), st)) {
          a.style.setProperty('box-sizing', 'border-box', 'important'),
            (r.className =
              'uiiw fflag fflag-' + st + ' lst-btn-flag ff-round')
          var u = void 0
          switch (t) {
            case 'mini':
              u = '1px'
          ...
          var l =
            'url("' +
            ct.cdn +
            'frontend/images/circle-flags/' +
            st.toLowerCase() +
            '.svg")'
          r.style.setProperty('border-style', 'solid', 'important'),
            r.style.setProperty('border-width', u, 'important'),
            r.style.setProperty('background-image', l, 'important'),
            r.setAttribute('data-uw-ignore-s25', !0)
          var d = ct.cdn + 'frontend/images/flagSprite60.png',
            c = new Image()
          ;(c.onload = function () {
            var e = document.querySelector('.ulsti')
            null === e ||
              void 0 === e ||
              e.classList.remove('userway_loading')
          }),
            (c.src = d),
            c.complete && c.onload()
        }
  ...
  function P(e, t, i) {
    var n = document.querySelector('div.uwy'),
      r =
        '' +
        (_userway_config.type ||
          ct.tunings.widget_icon_type ||
          Ot.UW_WIDGET_ICON_TYPE),
      a = -1 !== ['4', '5', '6', '7'].indexOf(e),
      o = document.querySelector('.uai .uiiw')
    if ('4' !== r)
      n.classList.contains('uac') && n.classList.remove('uac'),
        (o.innerHTML =
          '<img data-uw-rm-ignore="" class="' +
          (t.isLight ? 'ui_b' : 'ui_w') +
          '" role="presentation" alt="" src="" />')
    else {
      mt.addUwStylesheetMetropolisFont(ct), n.classList.add('uac')
      var s = bt.translate,
        u = s(ct.language, 'widget.text_icon_small'),
        l = s(ct.language, 'widget.text_icon_large'),
        d = 'large' !== i || mt.isMobile() ? u : l
      o.innerHTML =
        '<div class="accessibility-btn"><span style="font-family: Metropolis, sans-serif!important;" class="accessibility-btn__text">' +
        d +
        '</span></div>'
    }
    var c = document.querySelector('.uai img.ui_w'),
      p = document.querySelector('.uai img.ui_b')
    switch (r) {
      case '1':
        R(t, p, c, 'body'),
          p && p.setAttribute('alt', ''),
          c && c.setAttribute('alt', '')
        break
      case '2':
        a ? R(t, p, c, 'wheel_right') : R(t, p, c, 'wheel_left'),
          p && p.setAttribute('alt', ''),
          c && c.setAttribute('alt', '')
        break
      case '3':
  ...
  function R(e, t, i, n) {
    e && e.isLight ? F(t, n + '_bl.svg') : F(i, n + '_wh.svg')
  }
  function F(e, t) {
    e.setAttribute('src', ct.cdn + 'widgetapp/images/' + t)
  }
  function D(e) {
    var t, i
    e = void 0 === e ? 'toggle' : e
    ...
    try {
      for (var r = __values(n), a = r.next(); !a.done; a = r.next()) {
        ...
        'show' === e
          ? null === o ||
            void 0 === o ||
            o.classList.add('userway_loading')
          : 'hide' === e
          ? null === o ||
            void 0 === o ||
            o.classList.remove('userway_loading')
          : 'toggle' === e &&
            (null === o ||
              void 0 === o ||
              o.classList.toggle('userway_loading'))
      }
    } catch (e) {
      t = { error: e }
    } finally {
  ...
  function H() {
    var e,
      t,
      i,
      n = document.querySelector('.uai'),
      r = document.querySelector('.ulsti'),
      a = document.querySelector('.uwif'),
      o =
        (null === (e = ct.services) || void 0 === e
          ? void 0
          : e.CUSTOM_BRANDING) ||
        (null === (t = ct.services) || void 0 === t
          ? void 0
          : t.WHITE_LABEL) ||
        (null === (i = ct.tunings) || void 0 === i
          ? void 0
    ...
    null === n ||
      void 0 === n ||
      n.setAttribute('title', mt.getUserWayIconElementTitle(ct)),
      null === n ||
        void 0 === n ||
        n.setAttribute('aria-label', mt.getUserWayIconElementTitle(ct)),
      null === r ||
        void 0 === r ||
        r.setAttribute('title', mt.getUserWayLstIconElementTitle(ct)),
      null === r ||
        void 0 === r ||
        r.setAttribute('aria-label', mt.getUserWayLstIconElementTitle(ct)),
      a.setAttribute(
        'title',
        o
          ? mt.getUserWayIconElementTitle(ct)
          : 'UserWay ' + mt.getUserWayIconElementTitle(ct)
      )
  }
  function q() {
    var e = { color: Ot.UW_WIDGET_COLOR, gradient: null, isLight: !1 },
      t = ct.color || ct.tunings.widget_color
    if (t) {
      var i = mt.hexToRgb(t.replace('#', ''))
      ;(e.isLight = mt.colourIsLight(i[0], i[1], i[2])), (e.color = t)
    }
    ;(ct.color ||
      (ct.tunings.widget_color_gradient &&
        ct.tunings.widget_color_gradient ===
          Ot.UW_WIDGET_COLOR_GRADIENT)) &&
      (ct.tunings.widget_color_gradient = null)
    var n = ct.color_gradient || ct.tunings.widget_color_gradient
    return n && (e.gradient = n), e
  }
  function j() {
    var e = mt.getProperty(ct, zt)
    if (e) return (ct.userSpecificPosition = e), e
    var t = ct.tunings.widget_position
    return (
      mt.isMobile() &&
        ct.tunings.widget_position_mobile &&
        (t = ct.tunings.widget_position_mobile),
      'shortpoint' === ct.services.partner
        ? ct.position || t || '3'
        : _userway_config.position ||
          ct.position ||
          t ||
          Ot.UW_BUTTON_POSITION
    )
  }
  function z() {
    return (
      _userway_config.size ||
      ct.size ||
      ct.tunings.widget_icon_size ||
      Ot.UW_WIDGET_ICON_SIZE
    )
  }
  function B() {
    var e = q()
    if (e) {
      var t = document.querySelector('.uw-popup-header'),
        ...
        a = e.isLight ? '#000000' : '#ffffff'
      t &&
        (t.setAttribute(
          'style',
          'background: ' + r + '!important; color:' + a + '!important'
        ),
        i.setAttribute('style', 'color:' + a + '!important')),
        n && n.setAttribute('style', 'stroke: ' + a + '!important')
    }
  }
  function V() {
    var e,
        ...
        if (r) {
          if (s) {
            ...
            if ('ie' === mt.detectBrowser()) {
              ...
              ;(4 !== l && '4' !== l) ||
                (u +=
                  ';min-width:auto!important;max-width:none!important;min-height:auto!important;max-height:none;!important')
            }
            s.style.setProperty('background', u, 'important'),
              n.isLight
                ? (s.classList.add('uli'),
                  s.classList.remove('userway_dark'))
                : (s.classList.remove('uli'),
                  s.classList.add('userway_dark'))
          }
          var d = document.querySelector('.userway_hide_on')
          d && d.style.setProperty('background', n.color, 'important')
          var c = document.querySelector('.userway_hide_off')
          c && c.style.setProperty('background', n.color, 'important')
          var p = document.querySelector('.uhi span')
          p && p.style.setProperty('background', n.color, 'important')
        } else
          null === s || void 0 === s || s.classList.add('userway_dark')
      }
    } catch (t) {
      e = { error: t }
    } finally {
    ...
    mt.postMessage({ action: 'setWidgetColour', payload: n || null })
  }
  function G() {
    var e = 'fo' === ct.language && ct.partner !== atob('ZmFyb2U=')
    !Et.isAvailable({
      pageLanguage: ct.widgetPageLang,
      widgetLanguage: ct.language,
    }) || e
  ...
  function Y() {
    ;(ct.reader.enabled = !0),
      mt.postMessage({ action: 'screen_reader_available' })
  }
  function K() {
    He.disable(),
      (ct.reader.enabled = !1),
      mt.postMessage({ action: 'screen_reader_not_available' })
  }
  function J(e, t) {
    void 0 === t && (t = !1),
      e &&
        (t || mt.setProperty(ct, Vt, e),
        (ct.tunings.widget_language = e),
        (ct.language = e),
        (pt = !0),
        it.updateDictionaryConfigs(),
        t && ce(e),
        G(),
        'fo' === ct.language && ct.partner !== atob('ZmFyb2U=') && K(),
        bt.initializeLocale(e).finally(function () {
          var t = document.querySelector('div.uwy')
          mt.postMessage({ action: 'setHtmlLangAttribute', lang: e })
          var i = {
            'en-US':
              'Our site is built for you; use it in a way that works best for you',
            'ar': 'تم تصميم موقعنا من أجلك. استخدمه بطريقة تناسبك بشكل أفضل',
          }
          t.setAttribute(
            'title',
            location.hostname === atob('cmV2YW1wLnJha2JhbmsuYWU=')
              ? i[ct.language]
              : mt.getUserWayIconElementTitle(ct)
          )
        }))
  ...
  function X(e) {
    var t,
      i = null
    _userway_config && _userway_config.platform
      ? (i = _userway_config.platform)
      : window._userway_config &&
        window._userway_config.platform &&
        (i = window._userway_config.platform)
    ...
    var a = ct.account === atob('eExxdFhtQVRSdw=='),
      o = a ? {} : ct.settings,
      s = ct.uid,
      u = {
        settings: o,
    ...
    i && (u.platform = i),
      (null ===
        (t = null === ct || void 0 === ct ? void 0 : ct._userway_config) ||
      void 0 === t
        ? void 0
        : t.platfAppInstalledSiteId) &&
        (u.platfAppInstalledSiteId =
          ct._userway_config.platfAppInstalledSiteId),
      (ct && (ct.account || ct.code)) ||
        (console.warn(
          'Widget initialization error: no account/code provided. Default code will be used'
        ),
        (ct.account = 'qLb3sVM6fr'),
        (ct.defaultAccountUsed = !0))
    var l = new XMLHttpRequest()
    l.open('post', Ht + '/tunings/' + (ct.account || ct.code)),
      l.setRequestHeader('Content-Type', 'text/plain;charset=UTF-8'),
      (l.onload = function () {
        try {
          if (503 === l.status) throw new Error('Error 503')
          if (502 === l.status) throw new Error('Error 502')
          if (200 !== l.status) throw new Error('Not 200 status')
          var t = JSON.parse(l.response)
          if (200 !== t.code)
            return void console.error(
              'Initialization error: ' + t.code + ' - ' + t.message
            )
          ;(ct.cpr = t.data.cpr),
            (ct.tunings = t.data.tunings),
            (ct.services = t.data.services),
            (ct.cpr = t.data.cpr),
            (ct.partner =
              t.data.services && t.data.services.partner
                ? t.data.services.partner
                : null),
            (ct.widgetPageLang = St.resolvePageLangAttribute()),
            (ct.languageHardcoded = St.resolveOwnerLangHardcoded())
          var i =
            t.data.tunings.widget_language &&
            'null' !== t.data.tunings.widget_language &&
            'auto' !== t.data.tunings.widget_language
              ? t.data.tunings.widget_language
              : null
          ;(ct.language = St.resolve({ ownerLangSelection: i })),
            St.userLandSelectionIsDefaultLangSelected({
              ownerLangSelection: i,
            }) && mt.removeProperty(ct, Vt),
            (function () {
              var e
              ;(ct.remediation = t.data.remediationV2),
                (ct.imageAlt = t.data.imageAlt),
                (ct.statistics =
                  null === (e = t.data.globals) || void 0 === e
                    ? void 0
                    : e.widgetRemediationStatsCollecting),
                $t.forEach(function (e) {
                  var t = ct.tunings[e]
                  ct.tunings[e] = t ? JSON.parse(t) : null
                }),
                (UserWayWidgetApp.ContextHolder.config = ct)
            })(),
            bt.initializeLocale(ct.language).then(function () {
              var e =
                !!ct.widgetPageLang &&
                Et.isAvailable({
                  pageLanguage: ct.widgetPageLang,
      ...
      l.send(JSON.stringify(u))
  }
  function Z(e) {
    var t = e.remediation,
      i = e.tunings
    t || mt.fireUserWayRemediationCompletedEvent({ enabled: !1 })
    var n = e.services && e.services.paidAi,
      r = null,
      a = null
    t && t.commonSettings.enabled
      ? ((r = Ct),
        (a = 'sha256-Z13D26NBO7naDf76/nYKNttNh3lusZp4Du5bFkYBG5M='))
      : n &&
        ((r = Pt),
        (a = 'sha256-csQ58SnolM7BEpfum+4zQH+4YqVcbgahHdRbcmwqfzA=')),
      r &&
        ((UserWayWidgetApp.ContextHolder.remediationModulePromise =
          mt.execJs(It + r, a)),
        UserWayWidgetApp.addLib('remediationConfig', t),
        (UserWayWidgetApp.ContextHolder.remediationResources = null)),
      (t && !t.commonSettings.enabled) ||
        ((e.services.editorBuildUrl = It + Rt),
        r
          ? UserWayWidgetApp.ContextHolder.remediationModulePromise.then(
              function () {
                mt.execJs(
                  It + Nt,
                  'sha256-Zo9bJH/qD8y/9J1Mcn+RWSmBDLolhMLmeYn5tkHbtw0='
                )
              }
            )
          : i.widget_free_remediation_disable ||
            mt.execJs(
              It + Mt,
              'sha256-t3uDLLq90KLTfu59H5/g6sjGXI5utkesscWdpVXVkho='
            ),
        (null === t || void 0 === t ? void 0 : t.consolidated) &&
          mt.request({ method: 'GET', url: t.consolidated }).then(
            function (e) {
              e &&
                e.response &&
                (UserWayWidgetApp.ContextHolder.remediationResources =
  ...
  function Q(e, t) {
    e &&
      ...
      mt
        .execJs(
          It +
            'widgetapp/2024-05-10-12-03-58/translations/live_translations_1715342638247.js',
          'sha256-QWvF8Ko2pbYatvVX+cljlikzcW+UPSfL11FrICvm9Zk='
        )
        .then(function () {
          ...
          return new Promise(function (e) {
            var n = function (t) {
              Fe('enable', 'LIVE_TRANSLATIONS'), e(t)
            }
            t
              ? document.addEventListener(
                  mt.LIFE_CYCLE_EVENT.REMEDIATION,
                  function () {
                    return i().then(n)
                  },
                  { once: !0 }
  ...
  function $() {
    mt.execJs(
      It +
        'widgetapp/2024-05-10-12-03-58/performance/performance_1715342638247.js'
    ).then(function () {
      var e = UserWayWidgetApp.getLib('performance_logger')
      ut = e.getInstance('Features')
    })
  }
  function ee() {
  ...
  function te(e) {
    window.UserWay.widgetToggle(),
      'Enter' === e.key &&
        (e.preventDefault(), window.UserWay.widgetToggle())
  }
  function ie() {
    var e = Ne()
    e.length &&
      e.forEach(function (e) {
        e.hasAttribute('data-uw-trigger') ||
          (e.addEventListener('click', ee),
          e.addEventListener('keypress', te),
          e.setAttribute('data-uw-trigger', !0),
          e.setAttribute('data-uw-ignore-s25', !0),
  ...
  function ne() {
    ...
    var r = document.querySelector('body'),
      ...
      o = document.querySelector('.uwy'),
      s =
        (null === (i = ct.tunings) || void 0 === i
          ? void 0
          : i.widget_lst_button_enabled) &&
        2 ==
          (null === (n = ct.tunings) || void 0 === n
            ? void 0
            : n.widget_lst_button_type)
    r &&
      r.addEventListener(
        'touchstart',
        function (e) {
          for (var t = !1, i = e.target; i; ) {
            if (
              i.classList &&
              (i.classList.contains('uai') || i.classList.contains('uai'))
            ) {
              t = !0
              break
            }
          ...
          t || o.classList.remove('uo')
        },
        !!mt.supportsPassive && { passive: !0 }
      )
    try {
                ...
                function (e) {
                  if (
                    ...
                    !e.target ||
                      ...
                      !e.target.closest('.uwaw-dictionary-tooltip'))
                  ) {
                    de(
                      s && 'userwayLstIcon' === e.currentTarget.id
                        ? ni.lst
                        : ni.main
                    ),
                      setTimeout(function () {
  ...
  function re() {
    new MutationObserver(function (e) {
      return e.forEach(function (e) {
        'lang' === e.attributeName && G()
      })
    }).observe(document.querySelector('html'), { attributes: !0 })
  }
  function ae() {
    mt.fireUserWayLifeCycleEvent(mt.LIFE_CYCLE_EVENT.RENDER)
  }
  function oe() {
    try {
      var e =
        !!UserWayWidgetApp.ContextHolder &&
        !!UserWayWidgetApp.ContextHolder.config &&
        !!UserWayWidgetApp.ContextHolder.config.remediation
      mt.fireUserWayLifeCycleEvent(mt.LIFE_CYCLE_EVENT.INIT, {
        remediationEnabled: e,
      }),
        e || mt.fireUserWayRemediationCompletedEvent({ enabled: !1 })
    } catch (e) {}
  }
  function se(e, t, i) {
    void 0 === i && (i = null)
    var n = i ? { state: i } : null
    mt.fireUserWayLifeCycleEvent(e + t, n)
  }
  function ue() {
    try {
      var e = window.location.hash.substr(1)
      if ((e && e.toLowerCase() === Wt) || _userway_config.forceOpen)
        return (location.hash = Wt), fe()
      if (new RegExp('[?&]' + Wt, 'i').test(window.location.search))
        return fe()
    } catch (e) {}
  }
  function le(e) {
    ...
    try {
      var a =
        ...
        o =
          '1' ===
          (null === (r = ct.tunings) || void 0 === r
            ? void 0
            : r.widget_lst_button_type),
        s = []
      o || s.push(document.querySelector('div.uai')),
        a && s.push(document.querySelector('div.ulsti'))
      try {
        for (var u = __values(s), l = u.next(); !l.done; l = u.next()) {
          var d = l.value
          if (!d) return console.warn('Icon not found')
          e
            ? 'visible' === e
  ...
  function de(e) {
    ft ? ge() : (fe(e), ai('userway_widget_open'))
  }
  function ce(e) {
    ...
    if (!pt || t.src) {
      var i = function (e, t) {
        ...
        s = a
          ...
          .filter(Boolean),
        u = __spreadArray([r], __read(s), !1).join('&')
      t.setAttribute('src', Dt + e + '/index.html?' + u)
    }
    pt = !1
  }
  function pe() {
    ...
    var t = document.querySelector('.uwif')
    t.removeAttribute('aria-hidden'), t.removeAttribute('tabindex'), si(!0)
  }
  function ye() {
    document.querySelector('.uwy').classList.remove('uon')
    var e = document.querySelector('.uwif')
  ...
  function fe(e) {
    if (
      ...
      try {
        if (y()) {
          var t = new Audio(ct.cdn + 'widgetapp/sounds/widgetOpened.mp3')
          ;(Gt = new Audio(ct.cdn + 'widgetapp/sounds/widgetClosed.mp3')),
            t.play()
        }
      } catch (e) {}
      var i = document.querySelector('.uwif')
      ;(i.hasAttribute('src') && Zt) || D('show'),
        Promise.resolve()
          .then(function () {
            return i.hasAttribute('src')
              ? pe()
              : Ie().then(function () {
                  ;(yt = St.resolveUserLangSelection()),
                    yt && ct.language !== yt && (ct.language = yt),
                    ce(ct.language)
                })
          })
          .then(function () {
            try {
              mt.postMessageWithNotification(
                { action: 'toggled', state: 'show', trigger: e },
                'widgetOpened',
                function () {
                  ;(ft = !0), pe()
                }
            ...
            G(), Je && Je.hideActiveTooltip && Je.hideActiveTooltip()
          })
    }
  }
  function ge() {
    ...
    'object' == typeof e &&
      'function' == typeof e.highlightElements &&
      e.highlightElements()
    try {
      mt.postMessageWithNotification(
        { action: 'toggled', state: 'hide' },
        'widgetClosed',
        function () {
          ;(ft = !1), qe.onWidgetClosed(), ye()
        }
      )
    } catch (e) {
      console.error(e)
  ...
  function me(e) {
    void 0 === e && (e = ct.tunings)
    var t = mt.isMobile(),
      i = document.querySelector('.userway_buttons_wrapper'),
      n =
        t && e.widget_position_nudge_mobile
          ? e.widget_position_nudge_mobile.moveX
          : e.widget_position_nudge.moveX,
      r =
        t && e.widget_position_nudge_mobile
          ? e.widget_position_nudge_mobile.moveY
          : e.widget_position_nudge.moveY,
      a =
        t && e.widget_position_nudge_mobile
          ? e.widget_position_nudge_mobile.xOrientation
          : e.widget_position_nudge.xOrientation,
      o =
        t && e.widget_position_nudge_mobile
          ? e.widget_position_nudge_mobile.yOrientation
          : e.widget_position_nudge.yOrientation,
      s = t
        ? !e.position_mobile && e.widget_position_mobile
          ? parseInt(e.widget_position_mobile, 10)
          : parseInt(e.position, 10)
        : !e.position && e.widget_position
        ? parseInt(e.widget_position, 10)
        : parseInt(e.position, 10)
    if ((h(), n))
      if (-1 !== [1, 2, 3].indexOf(s))
        'right' === a && (n = -n),
          i.style.setProperty(
            'left',
            'calc(100vw - ' + (ei.leftRightSide.right + n) + 'px)',
            'important'
          )
  ...
  function be(e, t, i) {
    ...
    e &&
      ((ct.settings[t ? Bt : zt] = {}),
      mt.setProperty(ct, t ? Bt : zt, i ? n : null))
    var r = document.querySelector('.uwy'),
      a = document.querySelector('.uwif')
    ;(we(a, 'userway_p'),
    a.classList.add('userway_p' + n),
    r &&
      (we(r, 'userway_p'),
      r.classList.add('userway_p' + n),
      setTimeout(function () {
        r.style.setProperty('visibility', '', '')
      }, 250)),
    mt.getProperty(ct, 'userway_hidden')) &&
      document.querySelector('.uwy').classList.add('userway_hidden')
  }
  function _e() {
    var e = ['s2', 's4', 's6', 's7', 's12', 's13', 's14', 's23']
    return ct.services.hasOwnProperty('MODIFY_MENU') &&
      ct.services.MODIFY_MENU.is_enabled
      ? e.filter(function (e) {
          return (
            -1 !==
            ct.services.MODIFY_MENU.features_pattern.split('|').indexOf(e)
          )
        })
      : e
  }
  function he(e) {
    ct.settings.hideWidget = {}
    var t = e.timestamp > 0 ? { 'max-age': e.timestamp / 1e3 } : null
    mt.setCookie('hidewidget', e.timestamp, t),
      ge(),
      le('hidden'),
      _e().forEach(function (e) {
        ve(e, 0)
      })
    for (var i in ct.settings)
      ct.settings[i].hasOwnProperty('value') && (ct.settings[i].value = 0)
    mt.postMessage({ action: 'updateVisuallyImpairedState', config: !1 }),
      xe()
  }
  function ve(e, t) {
    var i = 'userway-' + e
    if (void 0 !== t)
      if ('s2' === e)
        (ct.settings[i].value = t),
          0 === t &&
            ((ct.settings['userway-s10'].value = t),
            (ct.settings['userway-s16'].value = t))
      else if ('s3' === e || 's14' === e || 's17' === e || 's23' === e)
        -1 !== [!1, 1, 2, 3].indexOf(t)
          ? (ct.settings[i].value = t)
          : (ct.settings[i].value = 0)
      else if ('s4' === e || 's19' === e)
        -1 !== [!1, 1, 2, 3, 4].indexOf(t)
          ? (ct.settings[i].value = t)
          : (ct.settings[i].value = 0)
      else if ('s21' === e || 's18' === e)
        -1 !== [!1, 1].indexOf(t)
        ...
        for (var n in ct.settings) ct.settings[n].value = 0
      else ct.settings[i].value = t
    xe(), Ee()
  }
  function xe() {
    for (var e in ct.settings)
      'userway_hidden' === e || e === Vt
        ? mt.setProperty(ct, e, ct.settings[e])
        : mt.setProperty(ct, e, ct.settings[e].value)
    UserWayWidgetApp.ContextHolder.config = ct
  }
  function Le() {
    for (var e in ct.settings)
      ct.settings.hasOwnProperty(e) &&
        (ct.settings[e].value = mt.getProperty(ct, e))
  }
  function Ae() {
    if ('undefined' != typeof _userway_config)
      for (var e in _userway_config)
        _userway_config.hasOwnProperty(e) && (ct[e] = _userway_config[e])
  }
  function Ee(e) {
    if (
      (void 0 === e && (e = !1),
      ...
      if (JSON.stringify(ct.settings) !== JSON.stringify(gt)) {
        if (((wt = {}), Object.keys(gt).length))
          for (var t in ct.settings)
            ct.settings.hasOwnProperty(t) &&
              gt.hasOwnProperty(t) &&
              ct.settings[t].value !== gt[t].value &&
              (wt[t] = JSON.parse(JSON.stringify(ct.settings[t])))
        else wt = ct.settings
        for (var t in wt)
          !(function (t) {
            if (ct.settings.hasOwnProperty(t)) {
              var i = ct.services && ct.services.paidAi
              if (
                ct.settings[t] &&
                ct.settings[t].value &&
                (i || -1 === ii.indexOf(t))
                ...
                var n = function () {
                  ...
                  r = mt.LIFE_CYCLE_EVENT.FEATURE_ENABLED_BASE,
                  a = null
                if ('userway-s2' === t) je.enableBigCursor(), (a = 's2')
                else if ('userway-s3' === t)
                  Be.turnOffColorFeature(),
                    Be.turnOnColorFeature(t, ct),
                    (a = 's3')
                else if ('userway-s4' === t) ze.enable(), (a = 's4')
                else if ('userway-s6' === t) Ve.enable(), (a = 's6')
                else if ('userway-s7' === t)
                  Ye.disable(), Ge.enable(), (a = 's7')
                else if ('userway-s9' === t)
                  qe.enable(),
                    He.enable().then(n),
                    (a = 's9'),
                ...
                else if ('userway-s10' === t)
                  je.enableReadingGuide(), (a = 's10')
                else if ('userway-s11' === t) {
                  var o = e ? 2e3 : 0
                  setTimeout(function () {
                    Ke.showPageStructureHeaders().then(n), (a = 's11')
                  }, o)
                } else
                  'userway-s12' === t
                    ? (Je.enable(), (a = 's12'))
                    ...
                    ? (Ye.enable(), (a = 's15'))
                    : 'userway-s16' === t
                    ? (je.enableReadingMask(), (a = 's16'))
                    : 'userway-s17' === t
                    ? (Qe.disable(), Qe.enable(), (a = 's17'))
                    : 'userway-s18' === t
                    ? (Be.enableSmartContrast(), (a = 's18'))
                    : 'userway-s19' === t
                    ? ($e.disable(), $e.enable(), (a = 's19'))
                    : 'userway-s23' === t
                    ? (et.disable(), et.enable(), (a = 's23'))
                    : 'userway-s21' === t
                    ? (it.enable().then(n), v(), (a = '21'))
                    : 'userway-s24' === t
                    ? (Promise.all([He.preload(), nt.enable()]).then(n),
                      ge(),
                      v(),
                      (a = 's24'))
                    : 'userway-s25' === t
                    ...
                    : 'userway-s107' === t
                    ? (a = 's107')
                    : 'userway-s108' === t && (a = 's108')
                a && se(r, a, ct.settings[t].value),
                  !['userway-s21', 'userway-s11', 'userway-s9'].includes(
                    t
                  ) && n()
              } else if (!e) {
                Re('disable', t)
                var r = mt.LIFE_CYCLE_EVENT.FEATURE_DISABLED_BASE,
                  s = null
                if ('userway-s2' === t) je.disableBigCursor(), (s = 's2')
                else if ('userway-s3' === t)
                  Be.turnOffColorFeature(), (s = 's3')
                else if ('userway-s4' === t) ze.disable(), (s = 's4')
                else if ('userway-s5' === t)
                  console.warn("s5 key: shouldn't happen anymore")
                else if ('userway-s6' === t) Ve.disable(), (s = 's6')
                else if ('userway-s7' === t) Ge.disable(), (s = 's7')
                else if ('userway-s9' === t)
                  He.disable(), qe.disable(), (s = 's9')
                else if ('userway-s10' === t)
                  je.disableReadingGuide(), (s = 's10')
                else if ('userway-s12' === t) Je.disable(), (s = 's12')
                else if ('userway-s13' === t) Xe.disable(), (s = 's13')
                else if ('userway-s14' === t) Ze.disable(), (s = 's14')
                else if ('userway-s15' === t) Ye.disable(), (s = 's15')
                else if ('userway-s16' === t)
                  je.disableReadingMask(), (s = 's16')
                else if ('userway-s17' === t) Qe.disable(), (s = 's17')
                else if ('userway-s18' === t)
                  Be.disableSmartContrast(), (s = 's18')
                else if ('userway-s19' === t) $e.disable(), (s = 's19')
                else if ('userway-s23' === t) et.disable(), (s = 's23')
                else if ('userway-s21' === t) {
                  it.disable(),
                    (s = 's21'),
                    document
                      .querySelector('.uwaw-dictionary-tooltip')
                      .classList.remove('uwaw-dictionary-tooltip_active')
                ...
                s && se(r, s), Fe('disable', t)
              }
            }
          })(t)
        gt = JSON.parse(JSON.stringify(ct.settings))
      }
      a() && Se(), (dt.showPageStructureLinks = Ke.showPageStructureLinks)
    }
  }
  function Se() {
    var e = document.querySelector('.uwy')
    Object.keys(ct.settings).some(function (e) {
      var t
      return (
        (null === (t = ct.settings[e]) || void 0 === t
          ? void 0
          : t.value) && 'userway-positionWidget' !== e
      )
    })
      ? e.classList.add('uen')
  ...
  function ke() {
    window.UserWay = new (function () {
      function e(e, t) {
        ...
        Ie().then(function (i) {
          dt.setFeature(e, t)
          var n = { action: 'feature_use', name: e }
          t && (n.value = t), mt.postMessage(n)
        })
      }
      var t = this
      return (
        ...
        (t.debug = function () {
          try {
            localStorage.setItem(
              'debug',
              'true' === localStorage.getItem('debug') ? 'false' : 'true'
            ),
        ...
        (t.toggleInitialPagePreload = function () {
          var e = window.localStorage.getItem(lt),
            t = !JSON.parse(e)
          window.localStorage.setItem(lt, t.toString()),
            console.log(
              'Initial page widget preload is ' +
                (t ? 'enabled' : 'disabled') +
                '!'
            )
        }),
        (t.setPosition = function (e, t, i) {
          void 0 === i && (i = !1), be(e, t, i)
        }),
        t
      )
    })()
  ...
  function Te(e) {
    ...
    (null === (t = ct.tunings) || void 0 === t
      ...
      ? '1' ==
        (null === (i = ct.tunings) || void 0 === i
          ? void 0
          : i.widget_lst_button_type)
        ? (e.querySelector('.ulsti').classList.remove('hidden'),
          e.querySelector('.uai').classList.add('hidden'))
        : '2' ==
            (null === (n = ct.tunings) || void 0 === n
              ? void 0
              : n.widget_lst_button_type) &&
          (e.querySelector('.uai').style.marginTop = '8px')
  ...
  function We(e) {
    ...
    a.classList.add('uw-s10-reading-guide'),
      o.classList.add('uw-s10-left-ruler-guide'),
      s.classList.add('uw-s10-right-ruler-guide'),
      u.classList.add('uw-s10-bottom-ruler-guide'),
      l.classList.add('uw-s10-reading-guide__arrow'),
      a.appendChild(l),
      Oe(a),
      Oe(o),
      Oe(s),
    ...
    ;(d.innerHTML = e),
      d.classList.add('uwy'),
      d.setAttribute('data-uw-feature-ignore', 'true'),
      d.setAttribute('data-uw-rm-ignore', 'true'),
      ct.isMobile && d.classList.add('umb'),
      d.style.setProperty('background-color', 'transparent', 'important'),
      d.style.setProperty('overflow', 'initial', 'important'),
      d.style.setProperty('visibility', 'hidden', ''),
      Te(d),
      Oe(d),
      d.setAttribute('title', mt.getUserWayIconElementTitle(ct))
    var c =
        (null === (t = ct.services) || void 0 === t
          ? void 0
          : t.CUSTOM_BRANDING) ||
        (null === (i = ct.services) || void 0 === i
          ? void 0
          : i.WHITE_LABEL) ||
        (null === (n = ct.tunings) || void 0 === n
          ? void 0
          : n.widget_no_logo),
      p = document.querySelectorAll('.uwif')
    if (p && p.length) {
      var y = p[0]
      y.setAttribute(
        'title',
        ...
        y.style.setProperty('max-width', '100vw', 'important'),
        y.style.setProperty('visibility', 'visible', 'important'),
        y.style.setProperty('opacity', '1', 'important'),
        y.style.setProperty('color-scheme', 'light', 'important')
      ;/Android/i.test(navigator.userAgent) &&
        (y.style.setProperty('height', '100%', 'important'),
        y.style.setProperty('max-height', '100%', 'important'))
    }
    var f = Ne()
    f && f.length && window.UserWay.iconVisibilityOff()
  }
  function Oe(e) {
    var t = document.body
  ...
  function Ie() {
    ...
    return Jt
      ? Kt
      : (mt.addUwStylesheetUDFFont(ct),
        !UserWayWidgetApp.lazyLoaded && e
          ? ((Jt = !0),
            (Kt = new Promise(function (e, t) {
              mt.execJs(
                It +
                  'widgetapp/2024-05-10-12-03-58/widget_app_lazy_1715342638247.js',
                'sha256-fuSnmn8F0OYHyGYrEmskCsVF2Tx69onjrKRy4FTLxPg='
              ).then(
                function (t) {
                  Ce(),
  ...
  function Ce() {
    ;(qe = UserWayWidgetApp.getLib('keyboard_navigation')),
      (je = UserWayWidgetApp.getLib('cursor')),
      (ze = UserWayWidgetApp.getLib('bigger_text')),
      (Be = UserWayWidgetApp.getLib('uw_color_manipulation_service')),
      (Ve = UserWayWidgetApp.getLib('highlinks')),
      (Ge = UserWayWidgetApp.getLib('legible_text')),
      (Ye = UserWayWidgetApp.getLib('dyslexia_font')),
      (He = UserWayWidgetApp.getLib('screen-reader-t')),
      (Ke = UserWayWidgetApp.getLib('page_structure')),
      (Je = UserWayWidgetApp.getLib('tooltips')),
      (Xe = UserWayWidgetApp.getLib('stop_animations')),
      (Ze = UserWayWidgetApp.getLib('spacing_text')),
      (Qe = UserWayWidgetApp.getLib('line_height')),
      ($e = UserWayWidgetApp.getLib('text_align')),
      (et = UserWayWidgetApp.getLib('saturation')),
      (it = UserWayWidgetApp.getLib('inlineDictionary')),
      (nt = UserWayWidgetApp.getLib('voice-navigation')),
      (ot = UserWayWidgetApp.getLib('hide_images'))
  }
  function Ne() {
    if (!ct || !Object.keys(ct.tunings).length) return null
    var e = ct._userway_config && ct._userway_config.trigger,
      t = ct.tunings && ct.tunings.widget_custom_trigger,
      i = ct.tunings && ct.tunings.widget_custom_trigger_enabled,
      n = e || (i && t ? t : null),
      r = []
    if (n) {
      '.' !== n[0] && (n = '#' + n)
  ...
  function Pe() {
    var e, t, i, n
    return (
      (null === (e = ct.services.WHITE_LABEL) || void 0 === e
        ? void 0
        : e.hide_logo) ||
      (null === (t = ct.tunings) || void 0 === t
        ? void 0
        : t.widget_no_logo) ||
      (null === (i = ct.services.CUSTOM_BRANDING) || void 0 === i
        ? void 0
        : i.custom_logo_image_link) ||
      (null === (n = ct.services.CUSTOM_BRANDING) || void 0 === n
        ? void 0
        : n.custom_logo_image_path)
    )
  }
  function Re(e, t) {
    ut && ut.time(e + ' ' + t)
  ...
  var De,
    ...
    st,
    ut,
    lt = 'should-preload-widget',
    dt = UserWayWidgetApp.addLib('main'),
    ct = {},
    pt = !1,
    yt = null,
    ft = !1,
    gt = {},
    wt = {},
    mt = UserWayWidgetApp.getLib('util'),
    bt = UserWayWidgetApp.getLib('localization_manager'),
    _t = UserWayWidgetApp.getLib('context_setter'),
    ht = UserWayWidgetApp.getLib('dom_observer'),
    vt = UserWayWidgetApp.getLib('skip_links'),
    xt = UserWayWidgetApp.getLib('scan_manager'),
    Lt = UserWayWidgetApp.getLib('USER_TRACKING'),
    At = UserWayWidgetApp.getLib('cpr_usage_detector'),
    Et = UserWayWidgetApp.getLib('tts-reader-status'),
    St = UserWayWidgetApp.getLib('widget_language_resolver'),
    kt = UserWayWidgetApp.getLib('helpers'),
    Tt = UserWayWidgetApp.getLib('WIDGET_HOTKEYS'),
    Wt = 'uaw',
    Ot = {
    ...
    zt = 'userway-positionWidget',
    Bt = 'userway-positionWidgetMobile',
    Vt = 'userway-selectedLang',
    Gt = null,
    Yt = !1,
    Kt = null,
    Jt = !1,
    ...
    Zt = !1,
    Qt = !1,
    $t = ['widget_position_nudge', 'widget_position_nudge_mobile'],
    ei = {
      leftRightSide: { top: 18, right: 13, bottom: 16, left: 13 },
      middle: { left: 50, top: 50 },
    },
    ti = St.resolvePageLangAttribute(),
    ii = [
      's9',
      's11',
      's18',
    ...
    ni = { main: 'main', lst: 'lst' },
    ri = 'uw-uid'
  ;(dt.init = e), (dt.isSoundEffectsEnabled = y)
  var ai = function (e, t) {
    var i
    void 0 === t && (t = ''),
      ct.services.paidAi &&
        (null ===
          (i = null === ct || void 0 === ct ? void 0 : ct.tunings) ||
        void 0 === i
          ? void 0
          : i.widget_ga_enabled) &&
        'function' == typeof gtag &&
        gtag('event', 'UserWay', { name: e, state: t })
  }
  dt.setPageStructureModalColor = B
  var oi
  ;(dt.manageIconVisibility = le), (dt.toggleWidget = de)
  var si = function (e) {
    mt.isMobile() && (document.body.style.overflow = e ? 'hidden' : '')
  }
  ;(dt.openWidget = fe),
    (dt.closeWidget = ge),
    (dt.getAvailableBunchOfFeatures = _e),
    (dt.setFeature = ve),
    (dt.getFeaturesSettings = function () {
      if (ct.services.paidAi || !ct.services.hasOwnProperty('paidAi'))
        return ct.settings
      var e = {}
      return (
        Object.keys(ct.settings).forEach(function (t) {
          ct.settings.hasOwnProperty(t) &&
            -1 === ii.indexOf(t) &&
            (e[t] = ct.settings[t])
        }),
