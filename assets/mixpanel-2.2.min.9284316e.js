;(function () {
  ...
  ;(function () {
    ...
    function q(a) {
      ...
      this.i =
        'localStorage' === b && c.localStorage.sa()
          ? c.localStorage
          : c.cookie
      this.load()
      this.jc(a)
    ...
    function C(a, b) {
      this.J = b.J
      this.ba = new G(a, { J: c.bind(this.h, this), i: b.i })
      this.B = b.B
      this.Yc = b.Zc
      this.la = b.la
      this.hd = b.jd
    ...
    function V(a) {
      a = a || {}
      return 'localStorage' === a.Pb ? c.localStorage : c.cookie
    }
    function W(a, b) {
      b = b || {}
      return (b.Ob || Ma) + a
    ...
    function sa(a, b, d) {
      !c.Wa(b) || !b.length
        ...
        : ((d = d || {}),
          ...
          d.o &&
            a &&
            d.o(d.od || '$opt_in', d.pd, { send_immediately: m }))
    }
    function ia(a, b) {
      return function () {
        var d = D
        try {
          ...
          c && (d = ta(c, { Eb: h, Pb: g, Ob: v, window: i }))
        } catch (e) {
          o.error(
    ...
    c.Ma = function (a) {
      c.a(a, function (b, d) {
        c.Lc(b) ? (a[d] = c.Ec(b)) : c.e(b) && (a[d] = c.Ma(b))
      })
      return a
    }
    ...
    c.Qa = function (a, b) {
      var b = b.replace(/[[]/, '\\[').replace(/[\]]/, '\\]'),
        c = RegExp('[\\?&]' + b + '=([^&#]*)').exec(a)
      if (c === r || (c && 'string' !== typeof c[1] && c[1].length))
        return ''
      c = c[1]
      try {
    ...
    c.cookie = {
      ...
      Cd: function (a, b, c, f, h, g, e) {
        ...
        e
          ? (i = '; domain=' + e)
          : f &&
            (i = (i = ra(t.location.hostname)) ? '; domain=.' + i : '')
        c &&
          ((k = new Date()),
    ...
    c.Bc = (function () {
      function a(a, b) {
        return (
          0 <=
          (' ' + a.className + ' ').replace(d, ' ').indexOf(' ' + b + ' ')
        )
      }
      function b(b) {
    ...
    c.info = {
      ...
      ma: function (a, b, d) {
        return d || c.j(a, ' OPR/')
          ...
          : c.j(a, 'SamsungBrowser/')
          ? 'Samsung Internet'
          : c.j(a, 'Edge') || c.j(a, 'Edg/')
          ? 'Microsoft Edge'
          : c.j(a, 'FBIOS')
          ? 'Facebook Mobile'
          : c.j(a, 'Chrome')
      ...
      aa: function (a) {
        ...
        return c.extend(
          c.fa({
            ...
            $referrer: t.referrer,
            $referring_domain: c.info.Rb(t.referrer),
            $device: c.info.Bb(z),
          }),
          {
      ...
      Rc: function () {
        return c.extend(
          c.fa({ $os: c.info.Mb(), $browser: c.info.ma(z, I.vendor, Y) }),
          { $browser_version: c.info.Ia(z, I.vendor, Y) }
        )
      },
      Oc: function () {
      ...
      if (0 === g.length)
        ...
        return (
          c.a(
            g,
            function (a) {
              c.Sb(a, this.Nb, function (a) {
                var c = {},
                  g = h.oa(d, this),
                  e = h.Jb.c('track_links_timeout')
                h.Oa(a, this, c)
                window.setTimeout(h.fc(f, g, c, m), e)
                h.Jb.o(b, g, h.fc(f, g, c))
              })
            },
            this
          ),
    ...
    E.prototype.fc = function (a, b, c, f) {
      var f = f || D,
        h = this
      return function () {
        if (!c.yc) (c.yc = m), (a && a(f, b) === D) || h.Ga(b, c, f)
      }
    }
    ...
    M.prototype.oa = function (a, b) {
      var c = M.ld.oa.apply(this, arguments)
      if (b.href) c.url = b.href
      return c
    }
    M.prototype.Oa = function (a, b, c) {
      c.Kb =
        2 === a.which || a.metaKey || a.ctrlKey || '_blank' === b.target
      c.href = b.href
      c.Kb || a.preventDefault()
    }
    ...
    G.prototype.$a = function (a) {
      try {
        return this.i.setItem(this.N, $(a)), m
      } catch (b) {
    ...
    C.prototype.ea = function () {
      this.Wb(this.B.batch_flush_interval_ms)
    }
    ...
    C.prototype.flush = function (a) {
      try {
        if (this.Ub) R.log('Flush: Request already in progress')
        else {
          var a = a || {},
          ...
          c.a(
            ...
            function (a) {
              var b = a.payload
              this.la && !a.Qc && (b = this.la(b))
              if (b) {
                b.event &&
                  b.properties &&
                  (b.properties = c.extend({}, b.properties, {
                    mp_sent_by_lib_version: '2.50.0',
                  }))
                var d = m,
                  f = a.id
                if (f) {
          ...
          if (1 > e.length) this.ea()
            ...
            var i = c.bind(function (e) {
                ...
                try {
                  ...
                  if (a.hc) this.ba.ud(v)
                    ...
                    if (1 < h.length) {
                      ...
                      this.h(
                        '413 response; reducing batch size to ' + this.D
                      )
                      this.ea()
                    } else
                      this.h(
              ...
              k = { method: 'POST', lc: m, Ic: m, ec: b }
            if (a.hc) k.fb = 'sendBeacon'
    ...
    j.prototype.set = H(function (a, b, d) {
      ...
      f.$set = c.extend({}, c.info.Rc(), f.$set)
      return this.k(f, d)
    })
    ...
    j.prototype.Fb = H(function (a, b, d) {
      var f = {},
        e = {}
      c.e(a)
        ? (c.a(
    ...
    j.prototype.append = H(function (a, b, d) {
      c.e(a) && (d = b)
      return this.k(this.wc(a, b), d)
    })
    j.prototype.remove = H(function (a, b, d) {
      c.e(a) && (d = b)
      return this.k(this.Tb(a, b), d)
    })
    j.prototype.ga = H(function (a, b, d) {
      c.e(a) && (d = b)
      return this.k(this.gc(a, b), d)
    })
    j.prototype.qd = H(function (a, b, d) {
      if (!c.Ib(a) && ((a = parseFloat(a)), isNaN(a))) {
        o.error(
    ...
    j.prototype.k = function (a, b) {
      ...
      return !this.Da()
        ? (this.qc(a),
          c.g(b) ||
            (this.p('verbose') ? b({ status: -1, error: r }) : b(-1)),
          c.truncate(d, 255))
        : this.d.Fa(
            {
              type: 'people',
    ...
    j.prototype.rc = function (a, b, d, f, e, g, j) {
      var i = this
    ...
    q.prototype.vd = function (a) {
      ...
      if (
        !a.cookie_name &&
        'mixpanel' !== a.name &&
        ((d = 'mp_' + a.token + '_' + a.name), (b = this.i.parse(d)))
      )
        this.i.remove(d), this.i.remove(d, m), this.w(b)
      this.i === c.localStorage &&
    ...
    q.prototype.remove = function () {
      this.i.remove(this.name, D, this.na)
      this.i.remove(this.name, m, this.na)
    }
      ...
      this.w(
        {
          ...
          $initial_referring_domain: c.info.Rb(a) || '$direct',
        },
        ''
      )
    }
    ...
    q.prototype.jc = function (a) {
      ...
      this.$b(a.disable_persistence)
      this.ad(a.cookie_domain)
      this.bd(a.cross_site_cookie)
      this.cd(a.cross_subdomain_cookie)
      this.fd(a.secure_cookie)
    }
    ...
    q.prototype.fd = function (a) {
      if (a !== this.Xb) (this.Xb = a ? m : D), this.remove(), this.save()
    }
    ...
    e.prototype.ka = function () {
      this.c('loaded')(this)
      this.qb()
      this.people.M(this.persistence.Hc())
    ...
    e.prototype.qb = function () {
      this.persistence.kc(t.referrer)
      this.c('store_google') &&
    ...
    e.prototype.Ea = function (a, b) {
      if (this.c('img'))
        return (
          this.l("You can't use DOM tracking functions with img = true."),
          D
        )
    ...
    e.prototype.tc = function (a) {
      ...
      if (
        ...
        var e = n.history.replaceState
        if ('function' === typeof e)
          n.history.replaceState = function (a, b, c) {
            e.call(n.history, a, b, c)
            n.dispatchEvent(new Event('mp_locationchange'))
          }
        n.addEventListener(
          'mp_locationchange',
    ...
    e.prototype.k = function (a, b, d, e) {
      var h = m
      if (ma) return this.za.push(arguments), h
      var g = {
        ...
        j = r
      if (!e && (c.Va(d) || 'string' === typeof d)) (e = d), (d = r)
      d = c.extend(g, d || {})
      if (!O) d.method = 'GET'
      var g = 'POST' === d.method,
      ...
      if ('img' in b)
        ...
        try {
          ...
          if (d.ec && 'undefined' !== typeof o.timeout) {
            o.timeout = d.ec
                ...
                if (e)
                  if (k) {
                    ...
                    try {
                      ...
                      if ((p.l(b), d.Ic)) a = o.responseText
                      else return
                    }
                    e(a)
                  } else e(Number(o.responseText))
              } else
                (a =
                  o.timeout &&
                  !o.status &&
                  ...
                  p.l(a),
                  e && (k ? e({ status: 0, error: a, R: o }) : e(0))
          }
          o.send(j)
        } catch (y) {
          p.l(y), (h = D)
    ...
    e.prototype.lb = function (a) {
      a = c.ha(a)
      'base64' === this.c('api_payload_format') && (a = c.xc(a))
      return { data: a }
    }
    e.prototype.Fa = function (a, b) {
      var d = c.truncate(a.data, 255),
        ...
        i = m,
        k = c.bind(function () {
          j.bc || (d = this.pb('before_send_' + a.type, d))
          return d
    ...
    e.prototype.o = K(function (a, b, d, e) {
      ...
      if (c.g(a)) this.l('No event name provided to mixpanel.track')
        ...
        var g = this.persistence.Tc(a)
        c.g(g) ||
          (b.$duration = parseFloat(
            ((new Date().getTime() - g) / 1e3).toFixed(3)
          ))
        this.qb()
        g = this.c('track_marketing') ? c.info.Nc() : {}
        if (this.I) {
          var j = this.I.replayId
          j && (b.$mp_replay_id = j)
        }
        b = c.extend(
          {},
    ...
    e.prototype.ed = K(function (a, b, d) {
      c.isArray(b) || (b = [b])
      var e = {}
      e[a] = b
      this.m(e)
    ...
    e.prototype.uc = K(function (a, b, c) {
      var e = this.s(a),
        h = {}
      e === l
        ? ((h[a] = [b]), this.m(h))
    ...
    e.prototype.Uc = K(function (a, b, c) {
      ...
      if (e !== l) {
        var h = e.indexOf(b)
        ;-1 < h && (e.splice(h, 1), this.m({ Bd: e }))
        0 === e.length && this.Q(a)
      }
      return this.people.remove(a, b, c)
    })
    e.prototype.td = K(function (a, b, d, e) {
      var h = c.extend({}, b || {})
      c.a(d, function (a, b) {
        a !== r && a !== l && (h[b] = a)
      })
    ...
    e.prototype.oc = function (a, b) {
      return a + '_' + JSON.stringify(b)
    }
    e.prototype.Gc = function (a, b) {
      var c = this.oc(a, b),
        e = this.kb[c]
    ...
    e.prototype.eb = K(function (a, b) {
      ...
      var b = b || {},
        ...
        e = c.extend(c.info.Oc(), c.info.Y(), c.info.ub()),
        e = c.extend({}, e, a)
      return this.o(d, e)
    })
    ...
    e.prototype.md = function (a) {
      c.g(a)
        ...
        : this.mb(a) || this.persistence.dd(a)
    }
    var Da = { persistent: m }
      ...
      d.persistent
        ...
        : ('undefined' === typeof b && (b = 'None'),
          c.a(
            a,
            function (a, c) {
              if (!this.P.hasOwnProperty(c) || this.P[c] === b)
                this.P[c] = a
            },
            this
          ))
    ...
    e.prototype.Zb = function (a) {
      if (c.e(a))
        c.extend(this.config, a),
          ...
          this.persistence && this.persistence.jc(this.config),
          (J = J || this.c('debug'))
    }
    ...
    e.prototype.pb = function (a) {
      var b = (this.config.hooks[a] || Ea).apply(
        this,
        L.call(arguments, 1)
      )
      'undefined' === typeof b &&
    ...
    e.prototype.mb = function (a) {
      return c.Hb(z) || this.U.Ac || c.Ta(this.xa, a)
    }
    e.prototype.sc = function () {
      ...
      if (this.Z()) this.ia({ clear_persistence: m })
        ...
        !this.qa() &&
        (this.c('opt_out_tracking_by_default') ||
          c.cookie.get('mp_optout'))
      )
    ...
    e.prototype.ia = function (a) {
      ...
      !this.c('disable_persistence') &&
        ...
        this.persistence.$b(a)
      a ? this.bb() : this.nc && this.ab()
    }
    e.prototype.W = function (a, b) {
      ...
      return a(this.c('token'), {
        o: b.track,
        od: b.track_event_name,
        pd: b.track_properties,
        Pb: b.persistence_type,
        Ob: b.cookie_prefix,
        vb: b.cookie_domain,
        wb: b.cookie_expiration,
        zc: b.cross_site_cookie,
    ...
    e.prototype.time_event = e.prototype.md
    e.prototype.track = e.prototype.o
    e.prototype.track_links = e.prototype.sd
    e.prototype.track_forms = e.prototype.rd
    ...
    e.prototype.alias = e.prototype.vc
    e.prototype.name_tag = e.prototype.Pc
    e.prototype.set_config = e.prototype.Zb
    ...
    e.prototype.opt_in_tracking = e.prototype.Lb
    ...
    e.prototype.get_group = e.prototype.Gc
    e.prototype.set_group = e.prototype.ed
    e.prototype.add_group = e.prototype.uc
    e.prototype.remove_group = e.prototype.Uc
    e.prototype.track_with_groups = e.prototype.td
    e.prototype.start_batch_senders = e.prototype.ab
    e.prototype.stop_batch_senders = e.prototype.bb
    e.prototype.start_session_recording = e.prototype.cc
    e.prototype.stop_session_recording = e.prototype.kd
    e.prototype.DEFAULT_API_ROUTES = A
    q.prototype.properties = q.prototype.aa
    q.prototype.update_search_keyword = q.prototype.kc
    q.prototype.update_referrer_info = q.prototype.gb
    q.prototype.get_cross_subdomain = q.prototype.Fc
