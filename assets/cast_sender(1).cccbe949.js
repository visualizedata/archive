...
*/
  ...
  chrome.cast.media.na = function () {
    chrome.cast.media.MediaMetadata.call(
      this,
      chrome.cast.media.D.MUSIC_TRACK
    )
    this.releaseDate =
      this.releaseYear =
      this.images =
  ...
  f.Lb = function () {
    if (this.playerState == chrome.cast.media.A.PLAYING && 0 <= this.g) {
      var a =
        this.currentTime +
        ((Date.now() - this.g) / 1e3) * this.playbackRate
      this.media &&
  ...
  f.Ib = function () {
    if (
      this.breakStatus &&
      void 0 !== this.breakStatus.currentBreakClipTime
    )
      return this.playerState == chrome.cast.media.A.PLAYING && 0 <= this.g
  ...
  chrome.cast.media.h.prototype.queueNext =
    chrome.cast.media.h.prototype.Vb
  chrome.cast.media.h.prototype.queuePrev =
  ...
  chrome.cast.j.prototype.removeMessageListener =
    chrome.cast.j.prototype.ec
  ...
  chrome.cast.j.prototype.setReceiverVolumeLevel =
    chrome.cast.j.prototype.lc
  var $a = function (a, b) {
  ...
  var ob = function () {
    ...
    qb = function (a, b) {
      ...
      if (
        a.playerState == chrome.cast.media.A.IDLE &&
        null == a.loadingItemId
      )
        (a.currentItemId = null),
          (a.loadingItemId = null),
          (a.preloadedItemId = null),
