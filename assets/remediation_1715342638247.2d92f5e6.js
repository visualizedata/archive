!(function () {
  function e(e) {
    setTimeout(function () {
      ;(n.totalProcessed.AUTOFOCUS_ON_LOAD = 0),
        t(e),
  ...
  function t(e) {
    ...
    t && ['INPUT', 'TEXTAREA'].includes(t.tagName)
      ? (t.blur(),
        t.setAttribute(n.DATA_ATTRIBUTE_NAME, 'autofocus'),
        (i = 1))
      : (i = 0),
      (n.totalProcessed.AUTOFOCUS_ON_LOAD = i),
      0 !== i && UserWayWidgetApp.ContextHolder.config.services.siteId,
      e({
      ...
      for (var u = 0, l = 0; l < t.length; l++) {
        ...
        if (!c.hasAttribute(i))
          if ('IFRAME' === c.nodeName) {
            ...
            s &&
              (s.toLowerCase().indexOf('youtube.com') ||
                s.toLowerCase().indexOf('vimeo.com')) &&
              (s.indexOf('autoplay=1') > -1 ||
                s.indexOf('autoplay=true')) &&
              (s.indexOf('mute=1') > -1 || s.indexOf('mute=true') > -1) &&
              (c.setAttribute(i, 'if'), u++)
          } else
            'VIDEO' === c.nodeName &&
              c.hasAttribute('autoplay') &&
              c.hasAttribute('muted') &&
              (c.setAttribute(i, 'vi'), u++)
      }
      e.onHelperRemediationCompleted(
        n.of('REMEDIATION_AUTO_PLAY_VIDEO', null, null, u, 0)
      ),
        o()
    } catch (e) {
      a(e)
...
var __assign =
  ...
  __generator =
    ...
    function (e, t) {
      ...
      return (
        (u = { next: r(0), throw: r(1), return: r(2) }),
...
!(function () {
  function e(e) {
    ...
    e.filteredElements
    if (!r.reset) return t()
    A.isSmartContrastEnabled() || i(),
      E.config.autofix && A.enable(),
      UserWayWidgetApp.ContextHolder.remediationResources
        ? ((D.acceptedFixes =
            UserWayWidgetApp.ContextHolder.remediationResources.Contrast ||
            []),
          l().then(t))
        : t()
  }
    ...
    var u = function (n) {
      n.children &&
        Array.from(n.children).forEach(function (n) {
          ...
          if (!(t.includes(i) || e(n) || l))
            return a(n) || !s(n) || o(n) || r.push(n), n.childNodes && u(n)
        })
    }
    return u(n), r
  }
  function r() {
    ;[].slice
      .call(document.querySelectorAll('[' + I + '=' + O.AUTOFIX + ']'))
      .forEach(function (e) {
        e.setAttribute(I, O.PARSED), S.resetInlineStyles(e, I, N)
      }),
      (E.config.autofix = !1)
  }
  function n() {
    ...
    ;[].slice.call(document.querySelectorAll(e)).forEach(function (e) {
      e.getAttribute(I) === O.AUTOFIX && S.resetInlineStyles(e, I, N),
        e.removeAttribute(I)
    }),
      (D.foundedIssues = []),
      (D.contrastIssues = [])
          ...
          case 0:
            E.enabled || n(),
              (e = function () {
                ...
                t.onHelperRemediationCompleted(
                  _.of(
                    v,
                    {
                      items: (function (e) {
                        return e.map(function (e) {
                          return __assign(__assign({}, e), {
                            contrastData: __assign(
                              __assign({}, e.contrastData),
                    ...
                    null,
                    D.foundedIssues.length,
                    0
                  )
                )
              }),
              (o = E.config.autofix || A.isSmartContrastEnabled()),
              (l.label = 1)
          case 1:
      ...
      return __generator(this, function (l) {
        switch (l.label) {
          ...
          case 4:
            throw (
              ((u = l.sent()),
              console.error('Error in the Color Contrast helper:', u),
              u)
            )
          case 5:
            return o++, [3, 1]
          case 6:
            return (
              c(),
              (D.foundedIssues = D.foundedIssues.concat(
                D.contrastIssues.slice()
              )),
              (D.contrastIssues = []),
              r && r(),
              t && A.autofixAllIssues(),
              [2]
            )
        }
      })
  ...
  function l() {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (i) {
        switch (i.label) {
          case 0:
            if (W || !D.acceptedFixes.length) return [3, 6]
            ;(e = []), (i.label = 1)
          case 1:
  ...
  function c() {
    var e = function (e, t, r) {
        ...
        var n = 0
        return (
          (n = r ? (e + 0.05) * (t + 0.05) - 0.05 : (t + 0.05) / e - 0.05),
          n < 0 ? 0 : n > 1 ? 1 : n
        )
      },
      t = function (t, r, n, i) {
    ...
    ;(function (e, t) {
      ...
      return (
        ...
        e.reduce(function (e, t) {
          ...
          return (
            e.set(
              n,
              __spreadArray(__spreadArray([], __read(i), !1), [t], !1)
            ),
            e
          )
        }, new Map())
      ...
      D.contrastIssues,
      'contrastData.backgroundColorParentElement'
      ...
      o.every(function (e) {
        return (
          e.contrastData.foreground[4] === i.contrastData.foreground[4]
        )
      })
        ? r.push(
            __assign(__assign({}, i), {
      ...
      (D.contrastIssues = r.map(function (e) {
        ...
        var c = f(r)
        return (
          new F(c).contrast(l).ratio < n && (u = t(a, c, n, !0)),
          __assign(__assign({}, e), {
            suggestion: { foreground: r, background: u },
          })
        )
      }))
  }
    ...
    return (
      ...
      (Array.from(e.childNodes).some(function (e) {
        var r = e.nodeType,
          n = e.nodeValue
        return (
          3 === r && n.length > 0 && -1 === n.search(/^\s+$/i) && (t = !0)
        )
      }),
      ((e instanceof HTMLInputElement && e.value.length > 0) ||
        (e instanceof HTMLSelectElement && e.options.length > 0)) &&
        (t = !0),
      t)
    )
  }
          ...
          case 1:
            return (
              ...
              t.join('') === n.join(''))
                ? [2]
                : ('0' === n[3] &&
                    (n = ['255', '255', '255', '1', 'rgb(255, 255, 255)']),
                  C(i) && (i = e),
                  1 === parseFloat(n[3]) && y(e, t, n, i),
                  [2])
            )
        }
      })
        ...
        switch (y.label) {
          case 0:
            if (
              ...
              (r = document.body === e),
              (n = t.background.indexOf('linear-gradient') > -1),
              (i =
                t.backgroundImage.indexOf('url') > -1 ||
                t.background.indexOf('url') > -1),
              (o = new RegExp(
              ...
              !r && a(t.backgroundColor) && !n && !i)
            )
              return [2, m(e.parentElement)]
            if (
              (n &&
                a(t.backgroundColor) &&
                (u = (t.background.match(o) || []).find(function (e) {
                  return !a(e)
                })),
              !i || !a(t.backgroundColor))
            )
              return [3, 6]
            if (
              ((l = ['.svg']),
              (c = l.some(function (e) {
                return (
                  -1 !== t.backgroundImage.indexOf(e) ||
                  -1 !== t.background.indexOf(e)
                )
              })))
            )
              return [2, m(e.parentElement)]
            ;(s =
              t.backgroundImage.indexOf('url') > -1
                ? t.backgroundImage.slice(4, -1).replace(/['"]/g, '')
                : t.background.match(/url\(["']?([^"']*)["']?\)/)[1]),
              (y.label = 1)
          case 1:
          ...
          case 6:
            return (
              (p = f(u || t.backgroundColor)),
              (+t.opacity < 1 || 'none' !== t.filter) && (p[3] = '.1'),
              [2, { backgroundColor: p, targetElement: e }]
            )
        }
      })
    })
      ...
      i.setAttribute('crossOrigin', ''),
        ...
        i.addEventListener('load', function () {
          ...
          ;(n.imageSmoothingEnabled = !0),
            n.drawImage(i, 0, 0),
            (e = n.getImageData(0, 0, 1, 1).data.slice(0, 3)),
            t(o(e))
        }),
  ...
  function y(e, t, r, n) {
    var i = { ratio: null, contrastRatio: null },
      o = new F(t),
      a = new F(r),
      u = o.contrast(a),
      l = u.ratio
  ...
  function g(e) {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (y) {
        switch (y.label) {
          case 0:
            return (e = x.recursiveXpathSearch(n)) && 'boolean' != typeof e
              ? ((i = p(e)), [4, m(e)])
              : [2]
          case 1:
            return (
              ...
              (c = l.getPropertyValue('font-size')),
              (s = l.getPropertyValue('font-weight')),
              (d = (72 * Number(c.substring(0, c.length - 2))) / 96),
              (f =
                d >= 18 ||
                (d >= 14 && ('bold' === s || parseInt(s) >= 700))),
              (h = f ? 3 : 4.5),
              [
                2,
                {
                  ...
                  suggestion: { foreground: r, background: t },
                  expectedRatio: h,
                  tagName: e.tagName,
                  xpath: n,
                  fontSize: d,
  ...
  var v = 'REMEDIATION_COLOR_CONTRAST',
    ...
    x = UserWayWidgetApp.getLib('xpath_search'),
    ...
    D = { foundedIssues: [], contrastIssues: [], acceptedFixes: [] },
    M = function () {
    ...
    H = function (e) {
      return (
        e.hasAttribute(I) && [O.AUTOFIX, O.SET].includes(e.getAttribute(I))
      )
    }
  ;(A.isSmartContrastEnabled = function () {
    ...
    (A.filter = function (e, r) {
      return E.enabled && (L || E.config.autofix)
        ? (r.reset && !A.isSmartContrastEnabled() && i(), t())
        : []
    }),
    (A.awaitForResources = function (t, r) {
      return new Promise(function (n, i) {
        e({ resolve: n, reject: i, params: r, filteredElements: t })
      })
    }),
    ...
    (A.fixIssues = function (e, t) {
      ...
      if (
        (e.forEach(function (e) {
          var t = e.xpath && x.recursiveXpathSearch(e.xpath)
          if (t && 'boolean' != typeof t) {
            var n = e.childrenIssues,
              ...
              a = i
                .map(function (e) {
                  return x.recursiveXpathSearch(e)
                })
                .filter(function (e) {
                  return !!e && 'boolean' != typeof e
                })
            if (a.length)
              S.applyInlineStyles(t, I, { background: e.background }),
                t.setAttribute(I, O.SET),
                a.forEach(function (t, n) {
                  S.applyInlineStyles(t, I, { color: e.foreground }),
                    t.setAttribute(I, O.SET),
                    r.push(
                      __assign(__assign({}, o), {
              ...
              var u = { color: e.foreground, background: e.background }
              S.applyInlineStyles(t, I, u),
                t.setAttribute(I, O.SET),
                r.push(e)
            }
          }
        ...
        T(i),
          (D.foundedIssues = D.foundedIssues.filter(function (e) {
            var t = e.xpath
            return !n.includes(t)
          }))
      }
        ...
        if (t) {
          ...
          if (!H(t))
            if (i.length)
              ...
              S.applyInlineStyles(t, I, o), t.setAttribute(I, O.AUTOFIX)
            }
        }
      }),
    ...
    (A.resetAutofixed = r),
    (A.resetIssuesFixes = function () {
      i(),
        (D.acceptedFixes = []),
        (D.foundedIssues = D.foundedIssues.concat(U())),
        P()
    }),
    (A.run = u)
  var F = (function () {
      function e(e) {
        if (((this.rgba = null), 'transparent' === e))
          this.rgba = [0, 0, 0, 0]
      ...
      return (
        ...
        (e.prototype.isLight = function () {
          var e = (this.luminance + 0.05) / 0.05
          return 1.05 / (this.luminance + 0.05) < e
        }),
        (e.prototype.overlayOn = function (e) {
          ...
          if (r >= 1) return t
          for (var n = 0; n < 3; n++)
            t.rgba[n] = t.rgba[n] * r + e.rgba[n] * e.rgba[3] * (1 - r)
    ...
    j = (function () {
      ...
      return (
        (e.prototype.rgbToXyz = function (e) {
          var t = __read(
              e
                .map(function (e) {
                  return e / 255
                })
                .map(this.sRGBtoLinearRGB),
              3
            ),
            r = t[0],
            n = t[1],
            i = t[2]
          return [
            0.4124 * r + 0.3576 * n + 0.1805 * i,
            0.2126 * r + 0.7152 * n + 0.0722 * i,
            0.0193 * r + 0.1192 * n + 0.9505 * i,
          ].map(function (e) {
            return 100 * e
          })
        }),
        ...
        (e.prototype.labToRgb = function (e) {
          ...
          return (
            ...
            (i =
              1 *
              (i * i * i > 0.008856 ? i * i * i : (i - 16 / 116) / 7.787)),
            (a =
              1.08883 *
              (a * a * a > 0.008856 ? a * a * a : (a - 16 / 116) / 7.787)),
            (t = 3.2406 * o + -1.5372 * i + -0.4986 * a),
            (r = -0.9689 * o + 1.8758 * i + 0.0415 * a),
            (n = 0.0557 * o + -0.204 * i + 1.057 * a),
            (t =
              t > 0.0031308
            ...
            (n =
              n > 0.0031308
                ...
                : 12.92 * n),
            [
              255 * Math.max(0, Math.min(1, t)),
              255 * Math.max(0, Math.min(1, r)),
              255 * Math.max(0, Math.min(1, n)),
            ].map(function (e) {
              return q(e)
            })
          )
  ...
  (function () {
    function e() {
      var e = UserWayWidgetApp.ContextHolder.config,
        t = e._userway_config.hasOwnProperty(
          'ai_custom_focus_style_enabled'
        )
      return t
        ? t &&
            (!0 === e._userway_config.ai_custom_focus_style_enabled ||
              'true' === e._userway_config.ai_custom_focus_style_enabled)
        : l.enabled
    }
    function t(e) {
      var t = {
        outline:
          l.outlineWidth + ' ' + l.outlineStyle + ' ' + l.outlineColor,
      }
    ...
    function i(e) {
      ...
      document[t]('mousedown', o),
        document[t]('keydown', a),
        document[t]('focusin', n),
        document[t]('focusout', m)
    }
    function o() {
      p = !1
    }
    ...
    var u = UserWayWidgetApp.addLib('REMEDIATION_FOCUS_STYLE'),
      ...
      f = { width: '2px', color: ' #0018FF', style: 'solid' },
      p = !1
    ;(u.apply = function () {
      var t, r, n, o
      if (e()) {
        var a =
            null ===
              (n =
                null ===
                  (r =
                    null === (t = UserWayWidgetApp.ContextHolder) ||
                    void 0 === t
                      ? void 0
                      : t.config) || void 0 === r
                  ? void 0
          ...
          u = (
            null ===
              (o = UserWayWidgetApp.getLib('remediationConfig').customFocus
                .config) || void 0 === o
              ? void 0
              : o.style
          )
            ? JSON.parse(
                UserWayWidgetApp.getLib('remediationConfig').customFocus
                  .config.style
              )
            : f
        ;(l.outlineWidth = u.width),
          (l.outlineColor = u.color || a),
          (l.outlineStyle = u.style),
          setTimeout(function () {
            i(!0)
          }, 500)
      }
      ...
      (u.updateOutlineStyle = function (e) {
        if (e.data && (e.data.update || null != e.data.enabled)) {
          var t = e.data.update,
            n = e.data.enabled
          ;(l.outlineWidth = t.width),
            (l.outlineStyle = t.style),
            (l.outlineColor = t.color),
            l.enabled !== n &&
              (i(l.enabled),
              [].slice
            ...
            (setTimeout(function () {
              var e,
                ...
                a = i.filter(function (e) {
                  return t.isElementVisible(e, { skipParentCheck: !0 })
                })
              try {
                for (
                  var u = __values(a), l = u.next();
                  !l.done;
                  l = u.next()
                ) {
                  var c = l.value,
                  ...
                  try {
                    for (
                      var d = ((n = void 0), __values(s)), f = d.next();
                      !f.done;
                      f = d.next()
                    ) {
  ...
  (function () {
    ...
    function n(e) {
      var t = e.callbackAggregator,
        ...
        c = e.items
      try {
        t.onHelperRemediationStarted(i),
          c.forEach(function (e) {
            ...
            e.querySelector('title').setAttribute(
              u,
              t ? l.GENERIC : l.UNKNOWN
            )
          }),
          t.onHelperRemediationCompleted(a.of(i, null, null, c.length, 0)),
          n()
      } catch (e) {
        o(e)
      }
    ...
    ;(o.filter = function (r, n) {
      ...
      (o.doRemediation = function (e, t) {
        return new Promise(function (r, i) {
          n({ callbackAggregator: e, items: t, resolve: r, reject: i })
        })
      })
  })()
var __read =
...
!(function () {
  function e(e) {
    e.forEach(function (e) {
      ...
      ;(y[e.type] = y[e.type] || {}),
        (y[e.type][t] = y[e.type][t] || {}),
        e.xpath ? (y[e.type][t][e.xpath] = e) : (y[e.type][t] = e)
    })
  }
  function t(t, r, n) {
    return s
      ? (UserWayWidgetApp.ContextHolder.remediationResources &&
          e(UserWayWidgetApp.ContextHolder.remediationResources.Headings),
        t())
      : t()
  }
  function r() {
    ...
    e && e.parentElement.removeChild(e),
      [].slice
        .call(document.querySelectorAll('[' + d + '="level"]'))
        .forEach(function (e) {
          e.removeAttribute(d),
  ...
  function n(e, t) {
    e.setAttribute('role', 'heading'),
      e.setAttribute('aria-level', '' + t),
      e.setAttribute(d, 'level')
  }
  function i(e) {
    var t = document.createElement('h1'),
      ...
      o = r || i
    if (o) {
      var a = y['ADD-H1'] && y['ADD-H1'].$all,
        u = y['ADD-H1'] && y['ADD-H1'][e],
        l = !!u,
        c = u || a,
      ...
      return (
        ...
        t.setAttribute(
          'style',
          'clip: rect(1px, 1px, 1px, 1px)!important;height:1px!important;width:1px!important;overflow:hidden!important;position:absolute!important;top:0!important;left:0!important;z-index:-1!important;opacity:0!important'
        ),
        t.setAttribute(d, 'h1'),
        t.setAttribute('id', 'userway-h1-heading'),
  ...
  function a(e, t, r, a) {
    if (
      (e.onHelperRemediationStarted('REMEDIATION_HEADING'), (h = []), s)
    ) {
      ...
      if ((a.length || i(u), a.length)) {
        if (
          !(
            'H1' === a[0].nodeName ||
            (a[0].hasAttribute('aria-level') &&
              '1' === a[0].getAttribute('aria-level'))
          )
        ) {
          var l = __read(i(u), 1),
            c = l[0]
        ...
        for (
          var g = void 0, b = 0, v = void 0, A = 0, _ = a.length;
          A < _;
          A++
        ) {
          if (!a[A].hasAttribute(f)) {
            var E = m.xpath(a[A])
            g = o(a[A])
            var w = m.composeElementTextRepresentation(a[A])
            if (1 === g && a[A].hasAttribute(d)) b = 1
            else if (
              ((v = {
                type: 'CONTENT',
                level: g,
              ...
              w &&
                1 === g &&
                0 !== A &&
                (a[A].setAttribute('role', 'heading'),
                a[A].setAttribute('aria-level', '2'),
                a[A].setAttribute(d, 'level'),
                (v.previousLevel = 1),
                (v.approved = !1),
                (v.type = 'LEVEL'),
                (g = 2),
              ...
              if (g > b + 1) {
                var S =
                    ...
                    y.LEVEL[u] &&
                    y.LEVEL[u][E] &&
                    y.LEVEL[u][E].correction,
                  x = !!S && y.LEVEL[u][E].approved
                ;(v.previousLevel = g), (v.approved = !1)
                var I = b + 1
                ;(v.type = 'LEVEL'),
                  a[A].setAttribute(d, 'level'),
                  (v.level = I),
              ...
              a[A].setAttribute('role', 'presentation'),
                a[A].setAttribute('aria-hidden', !0),
                m.addScreenRearedElement(
                  a[A],
                  'Empty heading',
                  'data-uw-rm-autofix-hide'
                ),
                (v.type = 'HIDE'),
                a[A].setAttribute(d, 'hide')
              var O = y.HIDE && y.HIDE.$all && y.HIDE.$all[E],
                N = y.HIDE && y.HIDE[u] && y.HIDE[u][E],
                L = N || O
              ;(v.approved = !!L && L.approved), h.push(v)
            }
          }
        }
      }
    ...
    e.onHelperRemediationCompleted(
      p.of(
        ...
        s
          ? 0
          : [].slice.call(document.querySelectorAll('[' + d + ']')).length,
        0
      )
    ),
      t()
    ...
    return s
      ? (r(),
        [].slice
          ...
          .filter(function (e) {
            return !e.hasAttribute('data-uw-rm-ae')
          }))
      : []
  }),
...
!(function () {
  ...
  function o(e) {
    var t = { SRC: 'src', CLASSNAME: 'class', ID: 'id' },
      r = e.getAttribute(t.SRC) || '',
      n = e.getAttribute(t.CLASSNAME) || '',
      o = e.getAttribute(t.ID) || '',
      a = i(r) || u(n) || o
    a
      ? (e.setAttribute('title', a), e.setAttribute(f, m.GENERIC))
      : e.setAttribute(f, m.UNKNOWN)
  }
  function a(e) {
    var t = e.getAttribute(p)
    e.setAttribute('title', t),
      e.setAttribute(f, m.GENERIC),
      e.removeAttribute(p)
  }
  function u(e) {
  ...
  function l(e) {
    var t = e.callbackAggregator,
      ...
      i = e.items
    try {
      t.onHelperRemediationStarted(c),
        i.forEach(function (e) {
          e.hasAttribute(p) ? a(e) : o(e)
        }),
        t.onHelperRemediationCompleted(d.of(c, null, null, i.length, 0)),
        r()
    } catch (e) {
      n(e)
    }
  ...
  var c = 'REMEDIATION_IFRAME_TITLE',
    ...
    m = { UPDATED_BY_ADMIN: 'adm', UNKNOWN: 'un', GENERIC: 'gn' }
  ;(s.filter = function (r, n) {
    return (
      n.reset && e(),
      t(
        __spreadArray([], __read(r), !1).reduce(function (e, t) {
          return __spreadArray(
            __spreadArray([], __read(e), !1),
            __read([].slice.call(t.querySelectorAll('iframe'))),
            !1
          )
        }, [])
      )
    ...
    (s.doRemediation = function (e, t) {
      return new Promise(function (r, n) {
        l({ callbackAggregator: e, items: t, resolve: r, reject: n })
      })
    })
})()
var __read =
...
!(function () {
  ...
  function t(t) {
    return t.filter(function (t) {
      var r, n, i, a, m, h, y, g
      if (
        ('function' == typeof t.hasAttribute && t.hasAttribute(u)) ||
        e(t)
      )
        return !1
      if (t.classList && t.classList.contains('betterbot_botInfoText'))
        return t.setAttribute(u, l.BETTERBOT_CHAT), !0
      if (
        'function' == typeof t.getAttribute &&
        c.indexOf(t.getAttribute('role')) > -1 &&
        !t.hasAttribute('tabindex')
      )
        return t.setAttribute(u, l.HAS_ROLE_NO_TABINDEX), !0
      var b = !1,
        v = !1
        ...
        try {
          for (var A = __values(s), _ = A.next(); !_.done; _ = A.next()) {
            ...
            if (t.hasAttribute(E) && !o.isElementEditable(t)) {
              ...
              try {
                for (
                  var w = ((i = void 0), __values(d)), S = w.next();
                  !S.done;
                  S = w.next()
                ) {
                  var x = S.value
                  t.hasAttribute(x) && (v = !0)
                }
              } catch (e) {
                i = { error: e }
              } finally {
      ...
      if (b && !v)
        return t.setAttribute(u, l.HAS_ONCLICK_NO_ONKEYPRESS), !0
      var I = !1,
        O = !1,
        N = !1,
        L = ['drag-and-drop']
      if ('function' == typeof t.hasAttribute) {
        N = t.hasAttribute('tabindex')
        try {
          for (var W = __values(f), R = W.next(); !R.done; R = W.next()) {
            var E = R.value
            if (
              L.indexOf(t.nodeName.toLowerCase()) < 0 &&
              t.hasAttribute(E) &&
              !o.isElementEditable(t)
            ) {
              ;(O = !1), (I = !0)
              try {
                for (
                  var C = ((y = void 0), __values(p)), k = C.next();
                  !k.done;
                  k = C.next()
                ) {
                  var x = k.value
                  t.hasAttribute(x) && (O = !0)
                }
              } catch (e) {
                y = { error: e }
              } finally {
      ...
      return !I || O || N
        ? !(
            ...
            t.hasAttribute('tabindex') ||
            t.hasAttribute('role')
          ) && (t.setAttribute(u, l.ANCHOR_NO_HREF), !0)
        : (t.setAttribute(u, l.HAS_NGCLICK_NO_NGKEYPRESS), !0)
    })
  }
  function r(e, t, r, n, a) {
    try {
      ...
      n.forEach(function (e) {
          ...
          return (
            ...
            t === l.BETTERBOT_CHAT
              ? (e.setAttribute('tabindex', '0'),
                ...
                e.setAttribute('aria-label', 'Start chat with us'),
                void o.clickOnEnter(e))
              : t === l.HAS_ROLE_NO_TABINDEX
              ? (e.setAttribute('tabindex', '0'), void o.clickOnEnter(e))
              : t === l.OVERFLOW_HELPER
              ? void e.setAttribute('tabindex', '0')
              : t === l.HAS_ONCLICK_NO_ONKEYPRESS
              ? void o.clickOnEnter(e)
              : t && e.getAttribute(u) === l.HAS_NGCLICK_NO_NGKEYPRESS
              ? (e.setAttribute('role', 'button'),
                e.setAttribute('tabindex', '0'),
                void o.clickOnEnter(e))
              : t === l.ANCHOR_NO_HREF
        ...
        e.onHelperRemediationCompleted(
          i.of('REMEDIATION_KEYBOARD_NAVIGATION', null, null, c, 0)
        ),
        t()
    } catch (e) {
      r(e)
...
!(function () {
  ...
  var t = UserWayWidgetApp.addLib('REMEDIATION_LABS'),
    r = UserWayWidgetApp.getLib('remediationConfig'),
    n = UserWayWidgetApp.getLib('util')
  t.apply = function () {
    var t, i, o
    try {
      ;(null === (t = r.labs) || void 0 === t ? void 0 : t.enabled) &&
        Object.keys(
          null !==
            (o =
              null === (i = r.labs) || void 0 === i ? void 0 : i.config) &&
            void 0 !== o
            ? o
            : []
        ).length > 0 &&
        n
          .execJs(
            'https://cdn.userway.org/widgetapp/2024-05-10-12-03-58/bundles/labs-01.js'
          )
          .finally(function () {
            setTimeout(function () {
              var t,
                ...
                for (
                  ...
                  switch (u.type) {
                    case 'navigation':
                      ...
                      break
                    default:
                      console.log('Unsupported remediation type', u.type)
                  }
                }
              } catch (e) {
                t = { error: e }
      ...
      console.info('PatternsRemediationLoader', e)
    }
  }
})(),
  (function () {
    function e(e, t) {
      ...
      UserWayWidgetApp.ContextHolder.remediationResources &&
        (s = UserWayWidgetApp.ContextHolder.remediationResources.Language),
        e()
    }
    function t() {
      ;[].slice
    ...
    function r(e, t, r, i) {
      ...
      try {
        r.onHelperRemediationStarted('REMEDIATION_SITE_LANGUAGE'),
          d && document.documentElement.setAttribute('lang', d.correction),
          i.forEach(function (e) {
            ...
            if (
              (r &&
                !n(r) &&
                (e.removeAttribute('xml:lang'), (r = null), (i = !0)),
              t &&
                !n(t) &&
                (e.removeAttribute('lang'), (t = null), (i = !0)),
              e === document.documentElement && !t)
            ) {
              var a = UserWayWidgetApp.ContextHolder.config
              ;(t = (a && a.language) || 'en'),
                e.setAttribute('lang', t),
                (i = !0)
            }
            t && r && t !== r && ((i = !0), e.setAttribute('xml:lang', t)),
              e.setAttribute(c, '' + i),
              i && o++
          }),
          r.onHelperRemediationCompleted(
            l.of(
              'REMEDIATION_SITE_LANGUAGE',
              { items: [{ count: o, lang: d }] },
              null,
              o,
              0
            )
    ...
    ;(o.filter = function (e, r) {
      ...
      r.reset && t()
      var n = [].slice.call(
        document.querySelectorAll('[lang], [xml\\:lang]')
      )
      return (
        document.documentElement && n.push(document.documentElement), i(n)
      )
    }),
  ...
  ;(r.filter = function (r, n) {
    ...
    (r.doRemediation = function (e, t, r) {
      return new Promise(function (r, o) {
        try {
          e.onHelperRemediationStarted('REMEDIATION_MARQUEE'),
            t.forEach(function (e) {
              e.setAttribute(i, '')
            }),
            e.onHelperRemediationCompleted(
              n.of('REMEDIATION_MARQUEE', null, null, t.length, 0)
            ),
            r(!0)
        } catch (e) {
          o(e)
...
!(function () {
  ...
  function t(e, t, n, i, a) {
    function u(e, t) {
      return (
        'label' === (null === t || void 0 === t ? void 0 : t.nodeName)
          ? [t]
          : []
      ).concat(e === t ? u(t.parentElement) : [])
    }
    try {
      var l = [],
        c = document.body
      i.forEach(function (e) {
        if (e && 'function' == typeof e.hasAttribute) {
          var t = e.hasAttribute('id') && e.getAttribute('id'),
            ...
            n = t
              ? [].slice.call(c.querySelectorAll('label[for="' + t + '"]'))
              : [],
            i = r
              ? [].slice.call(c.querySelectorAll('label[id="' + r + '"]'))
              : [],
            o = u(c, e)
          if (!(n.length + i.length + o.length <= 1)) {
            if (n.length <= 1 && i.length <= 1 && o.length <= 1) {
              ...
              if (
                (2 === a.length && a[0] === a[1]) ||
                (3 === a.length && (a[0] === a[1]) === a[2])
              )
                return
            }
            var s = { el: e }
            n.length && ((s.forId = t), (s.labelsForId = n)),
              i.length && ((s.labelledBy = r), (s.labelsLabelledBy = i)),
              o.length && (s.perentLabels = o),
              l.push(s)
          }
        }
      }),
        l.forEach(function (e) {
          if (
            ((!e.forId && !e.labelledBy) || e.perentLabels.length,
            !e.forId && !e.perentLabels)
          ) {
            var t = [].slice
              ...
              .filter(function (t) {
                return (
                  ...
                  t.getAttribute('aria-labelledby') === e.labelledBy
                )
              })
              .forEach(function (t, n) {
                var i = r()
                t.setAttribute('aria-labelledby', i),
                  e.labelsLabelledBy[n] &&
                    e.labelsLabelledBy[n].setAttribute('id', i)
              })
          ...
          if (!e.labelledBy && !e.perentLabels) {
            var t = [].slice
              ...
              .filter(function (t) {
                return (
                  t.hasAttribute('id') && t.getAttribute('id') === e.forId
                )
              })
              .slice(1)
              .forEach(function (t, n) {
                ...
                t.setAttribute('aria-labelledby', i),
                  (e.labelsForId[n] &&
                    e.labelsForId[n].removeAttribute('for')) ||
                    e.labelsForId[n].setAttribute('id', i)
              })
...
!(function () {
  ...
  function n(e, t, r, n) {
    try {
      ...
      n.forEach(function (e, t) {
        ...
        if (g[n]) {
          var h = g[n].rem_url
          h && !s && (e.setAttribute(p, e.href), (e.href = y + h)),
            l.indexOf(r) < 0 &&
              (a.push(
                Object.assign({}, g[n], {
                  name: c,
          ...
          b && !s && o.push({ hash: n, url: r }),
            l.indexOf(r.toLowerCase()) < 0 &&
              (a.push({
                pdf_url: e.href,
                pdf_hash: n,
                pdf_link: e.innerText,
        ...
        e.onHelperRemediationCompleted(
          s.of(
            'REMEDIATION_PDF_DOCUMENTS',
            { items: a },
            { items: o, path: h, props: { page: location.pathname } },
            a.length,
            a.length
          )
        ),
  ...
  function o(e) {
    return e.filter(function (e) {
      if (!e || e.nodeType !== Node.ELEMENT_NODE || 'A' !== e.nodeName)
        return !1
  ...
  ;(a.filter = function (e, n) {
    ...
    (a.awaitForResources = function (t, r) {
      return new Promise(function (r, n) {
        ...
        UserWayWidgetApp.ContextHolder.remediationResources &&
          UserWayWidgetApp.ContextHolder.remediationResources.Pdfs &&
          e(UserWayWidgetApp.ContextHolder.remediationResources.Pdfs)
        var a = []
        try {
        ...
        return a.length
          ? l.config.quotaExceeded
            ? (a.forEach(function (e) {
                e.setAttribute(m, '2')
              }),
              r(!0))
            : void c
                .sendBackEnd('/br-links/v0/pdf-links', null, {
  ...
  (function () {
    ...
    e.apply = function () {
      t.perSiteRemediation &&
        t.perSiteRemediation.enabled &&
        t.perSiteRemediation.resources &&
        r.execJs(t.perSiteRemediation.resources).finally(function () {
          r.fireUserWayLifeCycleEvent(
            r.LIFE_CYCLE_EVENT.REMEDIATION_CSR_LOADED
          )
        })
    }
  })()
    ...
    r.on('UW_CER_POPUP_ON', function (e) {
      ...
      !(function (e, r) {
        setTimeout(function () {
          ...
          t.clickOnEnter(r)
          var a = Array.from(
            e.querySelectorAll(t.focusableElementsSelector)
          ).filter(function (e) {
            return (
              r !== e &&
              t.isElementVisible(e, { skipParentCheck: !0 }) &&
          ...
          if (a.length) {
            null === r || void 0 === r || r.setAttribute('tabindex', '0')
            var s = r ? __spreadArray([r], __read(a), !1) : a
...
!(function () {
  ...
  function t(e) {
    ...
    var n = t.filter(function (e) {
      return (
        !e.hasAttribute('role') &&
        (['A', 'BUTTON'].includes(e.tagName) || e.hasAttribute('tabindex'))
      )
    })
    return n.length ? n : []
  }
        ...
        !(function (r) {
          ...
          if (!r.hasAttribute(y)) {
            ...
            if (
              ...
              try {
                for (
                  var u = ((n = void 0), __values(a)), l = u.next();
                  !l.done;
                  l = u.next()
                ) {
                  var c = l.value
                  c.setAttribute('role', 'menuitem'),
                    c.setAttribute(y, 'menuitem')
                }
              } catch (e) {
                n = { error: e }
              } finally {
              ...
              if (!a.length && !e(r)) {
                ...
                r.setAttribute(y + '-role', s),
                  r.removeAttribute('role'),
                  m.onElementVisible(r, function () {
                    if (r.hasAttribute(y + '-role')) {
                      var e = r.getAttribute(y + '-role')
                      r.removeAttribute(y + '-role'),
                        r.setAttribute('role', e)
                    }
                  })
              }
            }
  ...
  function i(e) {
    Array.from(
      ...
      r.forEach(function (e) {
        ...
        i.length
          ? i.length !== r.length &&
            t.setAttribute(y + '-' + e, i.join(' '))
          : t.removeAttribute(y + '-' + e)
    })
  }
  function o() {
    var e = 0
  ...
  function a(e) {
    var t = 0
    return (
      Array.from(document.querySelectorAll('*[' + e + ']')).forEach(
        function (r) {
          if (!r.hasAttribute(y)) {
            ...
            n.forEach(function (e) {
              ...
              o.length &&
                (r.setAttribute(y + '-' + e, o.join(' ')),
                i.length
                  ? r.setAttribute(e, i.join(' '))
                  : r.removeAttribute(e)),
              (t += o.length)
          }
        }
  ...
  function u(e) {
    ...
    var r = window.getComputedStyle(e)
    if (
      !!r.getPropertyValue('text-decoration') &&
      r.getPropertyValue('text-decoration').indexOf('line-through') > -1
    )
      return !0
      ...
      for (var i = __values(n), o = i.next(); !o.done; o = i.next()) {
        ...
        if (!a.hasAttribute(y)) {
          ...
          l &&
            ...
            (a.setAttribute(y, ''),
            u(a) &&
              (a.setAttribute('aria-label', 'Previous price was ' + c[0]),
              a.setAttribute(y, 'price'),
              r++))
        }
      }
    } catch (t) {
  ...
  function c() {
    ;[].slice
      .call(document.querySelectorAll('[' + y + ']'))
      .forEach(function (e) {
        e.removeAttribute(y)
      })
  }
    ...
    (f.doRemediation = function (e, t, i) {
      return new Promise(function (i, a) {
        try {
          ...
          e.onHelperRemediationCompleted(
            p.of(
              'REMEDIATION_SCREEN_READER_BASIC',
              null,
              null,
              t.length + u + c + s,
              0
...
!(function () {
  function e(e) {
    return (
      !!['A', 'INPUT', 'BUTTON', 'SELECT', 'TEXTAREA'].includes(
        e.tagName
      ...
      for (var f = __values(s), p = f.next(); !p.done; p = f.next()) {
        ...
        if (!m.id || 'userwayAccessibilityIcon' !== m.id) {
          if (e(m) && ++d < 3) {
            ...
            if (
              h &&
              'uw-skip-to-main' !== m.id &&
              (h.toLowerCase().indexOf('skip') > -1 ||
                h.toLowerCase().indexOf('pass') > -1 ||
                h.toLowerCase().indexOf('jump') > -1)
            )
              return !0
          }
          if (d > 5) break
  ...
  function n(e, t, n, i) {
    try {
      ...
      ;-1 !== a.indexOf(o) ||
        r() ||
        (a.push(o), document.body.setAttribute(l, ''), (c = 1)),
        e.onHelperRemediationCompleted(
          u.of('REMEDIATION_SKIP_NAVIGATION_LINK', null, null, c, 0)
        ),
        t()
    } catch (e) {
      n(e)
      ...
      return {
        ...
        selector:
          null !==
            (t =
              null ===
                (e = null === o || void 0 === o ? void 0 : o.config) ||
              void 0 === e
                ? void 0
                : e.anchorSelector) && void 0 !== t
            ? t
            : null,
      }
    })
...
!(function () {
  function e(e, t) {
    var r =
      ...
      '/' +
      d.hashString(p)
    d.request({ method: 'GET', url: r }).then(
      function (t) {
  ...
  function t() {
    ;(h = {}),
      (g = []),
      [].slice
        .call(document.querySelectorAll('[' + m + ']'))
        .forEach(function (e) {
          e.removeAttribute(m)
        })
  }
  ...
  function a(e, t, a, l, c) {
    try {
      e.onHelperRemediationStarted('REMEDIATION_SOCIAL_SENSITIVITY'),
        (l = l.filter(function (e) {
          var t = e.parentNode
          return (
            (t && 'function' != typeof t.hasAttribute) ||
            !t.hasAttribute(m)
          )
        }))
      var f = 0,
      ...
      l.forEach(function (e) {
        ...
        if (
          (g.forEach(function (e) {
            ...
            n &&
              l.push.apply(
                l,
                __spreadArray([], __read(new Array(n.length).fill(e)), !1)
              )
          }),
          l && l.length)
        ) {
          f += l.length
          for (
            var c = d.xpath(e.parentElement), s = 0;
            s < l.length;
            s++
          ) {
            ...
            S && y++,
              w && !E && u(e, h, w),
              e.parentElement.setAttribute(m, ''),
              p.push({
                xpath: c,
                xpathHash: A,
                type: a,
        ...
        e.onHelperRemediationCompleted(
          s.of(
            'REMEDIATION_SOCIAL_SENSITIVITY',
            { items: p },
            null,
            f,
            p.filter(function (e) {
  ...
  ;(l.filter = function (e, r) {
    return c.enabled
      ? (r.reset && t(), f.ElementsWithText.getTextNodes(document, !1))
      : []
  }),
    (l.awaitForResources = function (t, r) {
      return c.enabled && c.config.resources && t.length && r.reset
        ? new Promise(function (t, r) {
            e(t, r)
          })
        : Promise.resolve()
...
!(function () {
  function e(e) {
    ...
    t && 'true' !== a && (e.ariaChecked = !0),
      t || 'false' === a || (e.ariaChecked = !1),
      r && 'true' !== u && (e.ariaReadOnly = !0),
      r || 'false' === u || (e.ariaReadOnly = !1),
      n && 'true' !== l && (e.ariaRequired = !0),
      n || 'false' === l || (e.ariaRequired = !1),
      i && 'true' !== c && (e.ariaDisabled = !0),
      i || 'false' === c || (e.ariaDisabled = !1),
      o && 'true' !== s && (e.ariaHidden = !0),
      o || 'false' === s || (e.ariaHidden = !1)
  }
  function t(t) {
    var r = function (r) {
        var n, i
  ...
  ;(r.filter = function (e, t) {
    ...
    (r.doRemediation = function (r, n, i) {
      var o = document.querySelectorAll(
        '[ng-show], [ng-hide], [ng-value], [ng-checked], [ng-readonly], [ng-required], [ng-model], [ng-disabled]'
      )
      return new Promise(function (r) {
        var n, i
        try {
          for (
            var a = __values(Array.from(o)), u = a.next();
            !u.done;
            u = a.next()
          ) {
            var l = u.value
...
!(function () {
  ...
  function r(e, r) {
    if (UserWayWidgetApp.ContextHolder.remediationResources)
      return (
        t(UserWayWidgetApp.ContextHolder.remediationResources.VagueLinks),
        e()
      )
    c.enabled ? e() : r()
  }
  function n(e) {
    return e.filter(function (e) {
      ...
      var r = e.hasAttribute('aria-label')
        ? e.getAttribute('aria-label')
        : null
      if (r && r.trim()) return !1
      var n = e.hasAttribute('aria-labelledby')
        ? e.getAttribute('aria-labelledby')
        : null
      ...
      i.forEach(function (t) {
        ...
        if (n) {
          ...
          m[i]
            ? ((r = m[i].correction),
              (l = m[i].approved),
              (c = Object.assign(m[i], { id: i })),
              u.push(c),
              (h[i] = __assign(__assign({}, c), { el: t })))
            : r ||
              ((r = a(t)),
              (c = {
                href: t.href,
              ...
              u.push(c),
              (h[i] = __assign(__assign({}, c), { el: t }))),
            (l || s) && t.setAttribute('aria-label', r),
            t.setAttribute('uw-rm-vague-link-id', i),
            t.setAttribute(p, '')
        }
      }),
        t.onHelperRemediationCompleted(
          f.of(
            'REMEDIATION_VAGUE_LINK',
            { items: u },
            null,
            u.length,
            u.filter(function (e) {
  ...
  function o(e) {
    ...
    return r.test(i)
      ? i.replace(r, 'call $1')
      : n.test(i)
      ? i.replace(n, 'send an email to $1')
      : t && t.trim()
      ? d
          .customTrim(t)
  ...
  function a(e) {
    ...
    for (
      var r = e.parentElement, n = e;
      d.customTrim(d.customTextContent(r)) === d.customTrim(e.textContent);

    )
      (n = r), (r = r.parentElement)
    for (
      var i = n.previousElementSibling, o = t(i);
      i && i.parentElement === r && !o;

    )
      (i = i.previousElementSibling), (o = i ? t(i) : null)
    if (o) return [e.textContent, o].join(' ')
    var a = (function (e, t) {
        for (
          var r, n = [], i = d.instantiateTreeWalker(e);
          (r = i.nextNode());

        )
          n.push({ node: r, target: r.parentElement === t })
        return n
      })(r, e)
        .map(function (e) {
          return {
  ...
  ;(u.filter = function (e, t) {
    ...
    (u.updateElement = function (e) {
      ...
      t &&
        t.el &&
        'function' == typeof t.el.setAttribute &&
        t.el.setAttribute('aria-label', e.correction)
    })
})()
var __assign =
    (this && this.__assign) ||
...
!(function () {
  ...
  ;(e.focusableElementsSelector =
    ...
    (e.keys = {
      isRightShift: function (e) {
        return (
          16 === e.keyCode || 'Shift' === e.key || 'ShiftRight' === e.code
        )
      },
      isLeftShift: function (e) {
        return (
          16 === e.keyCode || 'Shift' === e.key || 'ShiftLeft' === e.code
        )
      },
      isSpace: function (e) {
      ...
      isEsc: function (e) {
        return (
          27 === e.keyCode || 'Escape' === e.key || 'Escape' === e.code
        )
      },
      isTab: function (e) {
      ...
      isPageUp: function (e) {
        return (
          33 === e.keyCode || 'PageUp' === e.key || 'PageUp' === e.code
        )
      },
      isPageDown: function (e) {
        return (
          34 === e.keyCode || 'PageDown' === e.key || 'PageDown' === e.code
        )
      },
      ...
      isArrowUp: function (e) {
        return (
          38 === e.keyCode || 'ArrowUp' === e.key || 'ArrowUp' === e.code
        )
      },
    ...
    (e.generateRandomId = t.generateRandomId),
    (e.isElementEditable = function (e) {
      function t(e) {
      ...
      try {
        for (
          var o = __values(Array.from(e.querySelectorAll('*'))),
            a = o.next();
          !a.done;
          a = o.next()
        ) {
    ...
    (e.waitUntil = function (e, t, r, n) {
      void 0 === r && (r = null),
        void 0 === n && (n = null),
        (r = __assign({ timeout: 8e3, frequency: 1e3 }, r || {}))
      var i = Date.now()
      !(function o() {
        var a = e()
        if (a) return t(a)
        setTimeout(function () {
          if (r.timeout && Date.now() - i > r.timeout)
            return void (n && n())
          o()
        }, r.frequency)
      })()
    ...
    (e.trapFocusBetweenElements = function (t, r, n) {
      ...
      window.addEventListener('keydown', function (t) {
        ...
        (document.activeElement && n.contains(document.activeElement)) ||
          t.focus(),
    ...
    (e.trapFocusPopupElements = function (t, r) {
      void 0 === r && (r = null)
      var n = !1
      window.addEventListener('keydown', function (t) {
        e.keys.isLeftShift(t) && (n = !0)
      }),
        window.addEventListener('keyup', function (t) {
          e.keys.isLeftShift(t) && (n = !1)
        })
      var i = t[0],
        o = t[t.length - 1]
      ;(document.activeElement && r.contains(document.activeElement)) ||
        i.focus(),
    ...
    (e.trapFocusBetween = function (e) {
      function t(e, t, n) {
        if (9 === n.keyCode)
          return r ? t && t.focus() : e && e.focus(), n.preventDefault()
        16 === n.keyCode && (r = !0)
      }
      for (var r = !1, n = [], i = 0; i < e.length; i++) {
        ...
        if (o) {
          ...
          var a =
              document.querySelector(e[i + 1]) ||
              document.querySelector(e[0]),
            u =
              document.querySelector(e[i - 1]) ||
              document.querySelector(e[e.length - 1]),
            l = t.bind(event, a, u)
          n.push(l),
    ...
    (e.isElementVisible = function (e, t) {
      ;(t = t || {}),
        t.hasOwnProperty('skipParentCheck') || (t.skipParentCheck = !1),
        t.hasOwnProperty('shouldBeInViewport') ||
          (t.shouldBeInViewport = !0)
      var r = function (e, t) {
          if (!e) return !1
      ...
      if (!t.skipParentCheck)
        for (; n && e.parentNode && e.parentNode !== document; )
          r(e.parentNode, { shouldBeInViewport: !1 })
            ? (e = e.parentNode)
            : (n = !1)
      return n
    }),
    ...
    (e.getFocusableElement = function (t, r, n) {
      ;(t = t || 'next'),
        (n = n || {}),
        (n.childrenOnly = n.childrenOnly || !1),
        (n.canBeHidden = n.canBeHidden || !1)
      var i = Array.from(
        (n.childrenOnly ? r : document).querySelectorAll(
          e.focusableElementsSelector + (r ? ',' + e.getCssPath(r) : '')
        )
      )
      n.canBeHidden ||
      ...
      for (var t = 0, r = 0; e; ) {
        if ('BODY' == e.tagName) {
          ...
          ;(t += e.offsetLeft - n + e.clientLeft),
            (r += e.offsetTop - i + e.clientTop)
        } else
          (t += e.offsetLeft - e.scrollLeft + e.clientLeft),
            (r += e.offsetTop - e.scrollTop + e.clientTop)
        e = e.offsetParent
      }
      return { x: t, y: r }
    })
  ...
  ;(e.onHistoryPushState = function (e, t) {
    if (
      ...
      if (window.history) {
        ...
        window.history.pushState = function (e) {
          return (
            'function' == typeof window.history.onpushstate &&
              window.history.onpushstate({ state: e }),
    ...
    (e.queryXPath = function (e, t) {
      ...
      return (null === n || void 0 === n ? void 0 : n.singleNodeValue) &&
        (null ===
          (r = null === n || void 0 === n ? void 0 : n.singleNodeValue) ||
        void 0 === r
          ? void 0
    ...
    (e.loopThroughElements = function (t, r, n, i) {
      void 0 === n && (n = null),
        void 0 === i && (i = null),
        (n = __assign({ ancestor: document, useForEach: !0 }, n || {})),
        e.waitUntil(
          function () {
            if (n.ancestor) {
              var r = []
    ...
    (e.waitForElement = function (t, r, n, i) {
      void 0 === n && (n = null),
        void 0 === i && (i = null),
        (n = __assign({ ancestor: document }, n || {})),
        e.waitUntil(
          function () {
            if (n.ancestor)
              try {
  ...
  (function () {
    ...
    var t,
      r = UserWayWidgetApp.addLib('cpr_patterns_observer'),
      n = UserWayWidgetApp.getLib('util'),
      i = UserWayWidgetApp.getLib('remediation_util'),
      o = UserWayWidgetApp.getLib('remediationConfig'),
      a = (o && o.complex && o.complex, 'https://cdn.userway.org/'),
      u =
        'widgetapp/2024-05-10-12-03-58/remediation/nav_menu_helper_1715342638247.js',
      l = [],
      c =
        o.labs &&
        o.labs.enabled &&
        Object.keys(null !== (t = o.labs.config) && void 0 !== t ? t : [])
          .length > 0
    ;(r.apply = function (e) {
      s.filter(function (e) {
        return e.onPageLoad
    ...
    var s = [
      {
        ...
        path: 'widgetapp/2024-05-10-12-03-58/remediation/payoneer_account_1715342638247.js',
        onPageLoad: !0,
        onDomChanged: !1,
        observe: function () {
          var t = this
          'm8nhTkGuMw' === UserWayWidgetApp.ContextHolder.config.account &&
            (function () {
              e(
                t.name,
                t.path,
                'sha256-NJHPNbXQL8/yvJDyo23NXe1W44QtML+W756pkztQpYM=',
      ...
      },
      {
        ...
        remediationHelperName: '',
        path: 'widgetapp/2024-05-10-12-03-58/remediation/simplex_account_1715342638247.js',
        onPageLoad: !0,
        onDomChanged: !1,
        observe: function () {
          var t = this
          'DBnq3tIKbX' === UserWayWidgetApp.ContextHolder.config.account &&
            (function () {
              e(
                t.name,
                t.path,
                'sha256-7a+7Xg3vciW+Mne1lJuwv2A4CANleNvKOmGD12pHInM=',
                t.remediationHelperName
              )
            })()
        },
      },
      {
        ...
        remediationHelperName: '',
        path: 'widgetapp/2024-05-10-12-03-58/remediation/jqueryui_datepicker_1715342638247.js',
        onPageLoad: !0,
        onDomChanged: !1,
        observe: function () {
          ;[].slice
            .call(document.querySelectorAll('.hasDatepicker'))
            .filter(function (e) {
            ...
            e(
              this.name,
              this.path,
              'sha256-fzY74JVqYIY5N5yNkPCLVyawerLdVlcB7cdjZRcRfKs=',
              this.remediationHelperName
            )
        },
      },
      {
        ...
        path: 'widgetapp/2024-05-10-12-03-58/remediation/uw_aria_helper_1715342638247.ts',
        onPageLoad: !0,
        onDomChanged: !1,
        observe: function () {
          var t = this,
            r = function () {
              e(
                t.name,
                t.path,
                'sha256-skUcGYwV4ch6x37u65wVQrTZMuCIAUdYJOqbNwN54j0=',
                t.remediationHelperName
              )
            }
          i.waitUntil(
      ...
      },
      {
        name: 'slickSlider',
        remediationHelperName: '',
        path: 'widgetapp/2024-05-10-12-03-58/remediation/slick_slider_1715342638247.js',
        onPageLoad: !0,
        onDomChanged: !1,
        observe: function () {
          document.querySelector('.slick-slider') &&
            e(
              this.name,
              this.path,
              'sha256-HzbaajCSXjYzpdPrxYVWGL41xitmsBp335XXFB2zyNI=',
              this.remediationHelperName
            )
        },
      },
                ...
                ? (i.waitUntil(
                    ...
                    function () {
                      setTimeout(function () {
                        e(
                          'JQueryUiMenu',
                          'widgetapp/2024-05-10-12-03-58/remediation/jqueryui_menu_helper_1715342638247.js',
                          'sha256-vvjYbKhSaii5P+3Ctik4H+LTSHLvHDnybHBFwUSL1uQ=',
                          ''
                        )
                      }, 4e3)
                    },
                  ...
                  setTimeout(function () {
                    ;-1 === l.indexOf('JQueryUiMenu') &&
                      e(
                        'NavMenu',
                        u,
                        'sha256-SO73/mGj4sfIisHGomO9hRtqBTY2B+Uv0r5ORHLUIlU=',
                        ''
                      )
                  }, 14100))
                : -1 === l.indexOf('JQueryUiMenu') &&
      ...
      },
      {
        name: 'OwlCarousel',
        remediationHelperName: '',
        path: 'widgetapp/2024-05-10-12-03-58/remediation/owl_carousel_1715342638247.js',
        onPageLoad: !0,
        onDomChanged: !1,
        observe: function () {
          document.querySelector('.owl-carousel') &&
            e(
              this.name,
              this.path,
              'sha256-uURQpSwG3FAwlOtP33/NYxsGef08DBKWfqJwwNcAdU0=',
              this.remediationHelperName
            )
        },
      },
      {
        name: 'yotpoWidget',
        remediationHelperName: '',
        path: 'widgetapp/2024-05-10-12-03-58/remediation/yotpo_widget_1715342638247.js',
        onPageLoad: !0,
        onDomChanged: !1,
        observe: function () {
          document.querySelector('.yotpo') &&
            e(
              this.name,
              this.path,
              'sha256-GIuAq4nuA4gneXSAeZ/QDQug8Z/6Xbz2E9fOLGZV5Eg=',
              this.remediationHelperName
            )
        },
      },
      {
        name: 'judgeMe',
        remediationHelperName: '',
        path: 'widgetapp/2024-05-10-12-03-58/remediation/judgeme_widget_1715342638247.js',
        onPageLoad: !0,
        onDomChanged: !1,
        observe: function () {
          document.querySelector('.jdgm-star') &&
            e(
              this.name,
              this.path,
              'sha256-UbU25H+TzYB73LKY1BZpGepuOcR3Zq40WFZ/6Bf9s3s=',
              this.remediationHelperName
            )
        },
      },
      {
        ...
        remediationHelperName: '',
        path: 'widgetapp/2024-05-10-12-03-58/remediation/cycle_slider_helper_1715342638247.js',
        onPageLoad: !0,
        onDomChanged: !1,
        observe: function () {
          document.querySelector('.cycle-slide') &&
            e(
              this.name,
              this.path,
              'sha256-7d6M1UDXQDlMngKZI+asQoUOXwa4BMyeRqUCiDYsxas=',
              this.remediationHelperName
            )
        },
      },
      {
        ...
        remediationHelperName: '',
        path: 'widgetapp/2024-05-10-12-03-58/remediation/mui_elements_1715342638247.js',
        onPageLoad: !0,
        onDomChanged: !0,
        observe: function () {
          ;[
            ...
            e(
              this.name,
              this.path,
              'sha256-yXI4CdhFr5OhbD13f+WFeyHuPTtGa1K47eJRnqTztlI=',
              this.remediationHelperName
            )
        },
      },
      {
        ...
        remediationHelperName: '',
        path: 'widgetapp/2024-05-10-12-03-58/remediation/s_p_1715342638247.js',
        onPageLoad: !0,
        onDomChanged: !1,
        observe: function () {
          ;['[data-shortpoint-type="row"]'].some(function (e) {
            ...
            e(
              this.name,
              this.path,
              'sha256-wEsvu9mmG0N5053GtFHN4cn5qmr27+xhS3MMUa3MVBM=',
              this.remediationHelperName
            )
        },
      },
...
!(function () {
  ...
  var r,
    n = UserWayWidgetApp.addLib('remediation_utils')
  ...
  n.PROCESS_ATTRIBUTES = {
    CER: {
      ...
      hamburger: { button: 'data-uw-cer-hamburger-btn' },
    },
  }
  var u = {
    ...
    styles:
      ((r = { border: 'dashed 2px #c00' }),
      (r['border-radius'] = '3px'),
      (r['box-shadow'] = '0 0 0 4px yellow, inset 0 0 0 4px yellow'),
      r),
  }
  ;(n.sendBackEnd = function (e, t, r) {
    ...
    (n.highlightElements = function (e, t, r) {
      var n,
        ...
        l,
        c,
        s = document.querySelectorAll('.' + u.className)
      s.length &&
        s.forEach(function (e) {
          o.resetInlineStyles(e, u.attrMarker, u.styles),
            e.classList.remove(u.className)
        })
      var d = []
      switch (e) {
        case 'xpath':
      ...
      for (var E = 0; E < d.length; E++) {
        ...
        if (
          w &&
          'function' == typeof w.setAttribute &&
          (w.classList.add(u.className),
          o.applyInlineStyles(w, u.attrMarker, u.styles),
          !E && r.scroll)
        ) {
    ...
    (n.getElementAccessibleName = function (r) {
      ...
      if ((n = r.textContent ? r.textContent : null) && n.trim())
        return n.trim().toLowerCase()
      if (
        (n = r.value || '') &&
        n.trim() &&
        'INPUT' === r.tagName.toUpperCase() &&
        r.type &&
        -1 !== ['button', 'submit', 'reset'].indexOf(r.type.toLowerCase())
      )
        return n.trim().toLowerCase()
...
!(function () {
  ...
  e.instance = new (function () {
    ...
    ;(e.reset = function () {
      ...
      (e.mergeHelperOutcomes = function (e, n) {
        if (e.helperName !== n.helperName)
          throw (
            'Inconsistent helpers! Unable to merge ' +
            e.helperName +
            ' with ' +
            n.helperName
          )
        ...
        return (
          (e.postMessageAppData = i
            ? {
                items: e.postMessageAppData.items.concat(
                  n.postMessageAppData.items
                ),
              }
            : __assign({}, n.postMessageAppData)),
          (e.backEndData.items = n.backEndData.items),
          (e.countFixed = o ? e.countFixed + n.countFixed : n.countFixed),
          (e.countTodo = e.countTodo + n.countTodo),
          (e.hash = t.hashString(n.hash)),
          e
        )
      }),
      (e.put = function (t) {
      ...
      (e.getHelperPostMessagePayload = function (e) {
        var t = n[e]
        return t ? t.postMessageAppData : { items: [] }
      }),
  ...
  (function () {
    UserWayWidgetApp.addLib('remediation_changes_detector').instance =
      new (function () {
        function e() {
        ...
        ;(t.reset = function () {
          ...
          (t.anyChange = function (t) {
            return (
              n.length < r && n.push(t), n.length > r && (n = [t]), !e()
            )
          }),
      ...
      (UserWayWidgetApp.getHelpersPerformance = function () {
        ...
        return (
          Object.keys(t).forEach(function (r) {
            ...
            for (var i = 0; i < n.start.length; i++)
              e[r]['1_filter'].push(n['f-end'][i] - n['f-start'][i]),
                e[r]['2_resources'].push(n['a-end'][i] - n['a-start'][i]),
                e[r]['3_remediation'].push(
                  n['r-end'][i] - n['r-start'][i]
                ),
                e[r]['4_total'].push(n.end[i] - n.start[i])
          }),
          (t._aggregated = e),
          t
        )
  ...
  (function () {
    function e(e, t, n, i) {
      return new Promise(function (o, a) {
        ...
        try {
          ;(l = u.filter ? u.filter(t, i) : null),
            r.checkPointHelperFilterEnd(u.name, i)
        } catch (e) {
          return (
            r.checkPointHelperFilterEnd(u.name, i),
            r.checkPointHelperEnd(u.name, i),
            i.debugMode && console.error(e),
            o()
          )
        }
        r.checkPointHelperAwaitForResourcesStart(u.name, i),
          u
            .awaitForResources(l, i)
            .then(function () {
              r.checkPointHelperAwaitForResourcesEnd(u.name, i),
                r.checkPointHelperDoRemediationStart(u.name, i),
                u
                  .doRemediation(n, l, i)
                  .then(function () {
                    r.checkPointHelperDoRemediationEnd(u.name, i),
                      r.checkPointHelperEnd(u.name, i),
                      o()
                  })
                  .catch(function (e) {
...
!(function () {
  function e(e) {
    var t,
      r,
      n = [].slice.call(m.findAllElements(e)),
  ...
  function t(e, t) {
    ...
    return (
      i && 0 === e[0].indexOf(i) && u(i.offsetWidth, t) < 5 && (i = null),
      i
    )
  }
  function r(e, t) {
    return (
      e.classList.contains('tt-dropdown-menu') ||
      /datepicker/.test(e.getAttribute('class')) ||
      (!!e.id && 'klevuSearchingArea' === e.id) ||
      e.hasAttribute('data-uw-rm-ignore') ||
      !!Array.from(document.querySelectorAll('nav')).find(function (t) {
        return e.contains(t)
      }) ||
  ...
  function o() {
    return /^([^.]+\.)?manage\..*userway\.(dev|org)$/.test(
      window.location.host
    )
  }
  function a() {
    if (
      114355 === f.services.siteId ||
    ...
    var S = document.elementsFromPoint(g[0].x, g[0].y),
      ...
      O = i(t([S, x, I], r))
    if (O) return O
    var N = document.elementsFromPoint(b[0].x, b[0].y),
      L = document.elementsFromPoint(b[1].x, b[1].y),
      W = document.elementsFromPoint(b[2].x, b[2].y),
      R = i(t([N, L, W], r))
    if (R) return R
    var C = document.elementsFromPoint(y[0].x, y[0].y),
      k = document.elementsFromPoint(y[1].x, y[1].y),
      T = document.elementsFromPoint(y[2].x, y[2].y),
      ...
      if ((r.debugMode && (n = performance.now()), p.enabled)) {
        ...
        if (o) {
          ...
          if (-1 === h.indexOf(o)) {
            ...
            u && u.setAttribute(d.PROCESS_ATTRIBUTES.CER.popup.close, ''),
              s.emitEvent('UW_CER_POPUP_ON', [[o, u]]),
              r.debugMode && console.log('CER observer: POPUP found', o, u)
          }
        } else
          h.forEach(function (e) {
            s.emitEvent('UW_CER_POPUP_OFF', [e]),
              r.debugMode && console.log('CER observer: POPUP closed', e)
          }),
            (h = [])
      }
      r.debugMode &&
        ((i = performance.now()),
        console.log(
          'CER observer tick: execution took ' + (i - n) + ' milliseconds.'
        ))
    })
})()
var __read =
...
!(function () {
  ...
  function r() {
    L.getMeasurements && L.getMeasurements('Remediation')
  }
  function n(e) {
    return e
      ? __spreadArray(
  ...
  function i() {
    F.completedEventFired ||
      ((F.completedEventFired = !0),
      E.fireUserWayRemediationCompletedEvent({
        enabled: !0,
        counters: N.getHelpersOutcomeCounters(),
      }))
  }
  function o() {
    if (!F.iterationInProgress) {
      ...
      if (
        (I.consolidated ||
          E.fireUserWayRemediationCompletedEvent({ enabled: !1 }),
        e || D())
      )
        return void E.fireUserWayRemediationCompletedEvent({ enabled: !1 })
      var t = n(!F.domChangesEnqueued.length)
      ;(F.iterationInProgress = !0),
        (F.domChangesEnqueued = []),
        F.debugMode && console.log('UserWay Remediation: tick started'),
        w
          .series(t, [document.body], b.HelperCallbackAggregator, {
          ...
          .finally(function () {
            var e
            F.debugMode && console.log('UserWay Remediation: tick ended'),
              i(),
              M &&
                (S.tick({ processParameters: F }),
                null ===
                  (e = null === x || void 0 === x ? void 0 : x.tick) ||
                  void 0 === e ||
                  e.call(x, { processParameters: F })),
              setTimeout(function () {
                r(),
                  s(),
                  d(),
                  (F.iterationInProgress = !1),
                  F.domChangesEnqueued.length && o()
              }, 1e3)
          }),
        F.locationChanged && f(),
        (F.locationChanged = !1)
  ...
  function a() {
    ...
    V.forEach(function (r) {
      ...
      F.debugMode &&
        console.log(
          'UserWay Remediation: One-time helper applied %c' + r,
          'color:Red'
        ),
        null === (n = null === i || void 0 === i ? void 0 : i.apply) ||
          void 0 === n ||
          n.call(i, F),
        t(r)
    }),
      null === (r = null === x || void 0 === x ? void 0 : x.apply) ||
        void 0 === r ||
        r.call(x, { processParameters: F })
  }
  function u() {
    setTimeout(function () {
      o(),
        M && a(),
        F.debugMode && console.log('UserWay Remediation: process started'),
        v.on(W, function (e, t) {
          if (t && (!t || t.length)) {
            if (C)
              return void (
                F.debugMode &&
                console.log(
                  'UserWay Remediation: SKIP_DOM_CHANGES_REMEDIATION'
                )
              )
            F.debugMode &&
              console.log(
                'UserWay Remediation: tick resumed; initiator: DOM change'
              ),
              D() ||
                ((F.domChangesEnqueued = F.domChangesEnqueued.concat(t)),
                F.iterationInProgress || o())
          }
        })
    }, R)
  }
  function l(e) {
    ...
    t && (B.push('REMEDIATION_' + t), Y.push('REMEDIATION_' + t), o())
  }
  function c(e) {
    var t = UserWayWidgetApp.getLib('REMEDIATION_NAVIGATION_MENU')
    t && 'function' == typeof t.apply && t.apply(F), k && u()
  }
  function s() {
    p('remediation-count', N.getHelpersOutcomeCounters())
  }
  function d() {
    p('all-data', N.get())
  }
  ...
  function p(e, t) {
    F.debugMode &&
      (console.log(
        'UserWay Remediation PostMessage: %c[TYPE]: %c' + e,
        'color:Blue',
        'color:Red'
      ),
      console.group('%c[PAYLOAD]:', 'color:Blue'),
      console.log(t),
      console.groupEnd()),
      E.postMessage({ action: 'remediation', type: e, data: t })
  }
  var m,
    h,
    y,
    g,
    b = UserWayWidgetApp.addLib('remediation_manager'),
    v = UserWayWidgetApp.getLib('event_emitter'),
    ...
    N = UserWayWidgetApp.getLib('remediation_results_holder').instance,
    L = UserWayWidgetApp.getLib('performance_logger')
  b.ResultsHolder = N
  var W = A.DOM_OBSERVER_DOM_CHANGED_EVENT,
    R = (
      null === (m = null === O || void 0 === O ? void 0 : O.tunings) ||
      void 0 === m
        ? void 0
        : m.tech_rem_in_throttle_ms
    )
      ? Number(
          null === (h = null === O || void 0 === O ? void 0 : O.tunings) ||
            void 0 === h
            ? void 0
            : h.tech_rem_in_throttle_ms
        )
      : 1e3,
    C =
      null === (y = null === O || void 0 === O ? void 0 : O.tunings) ||
      void 0 === y
        ? void 0
        : y.tech_rem_dom,
    k =
      null === (g = null === O || void 0 === O ? void 0 : O.tunings) ||
      void 0 === g
        ? void 0
        : g.tech_rem_on_tab,
    T = document.querySelector('html'),
    U = E.isMobile(),
    P = L.getInstance ? L.getInstance('Remediation') : null,
    D = function () {
      if (location.pathname && location.pathname.indexOf('wp-admin') > -1)
        return !0
      var e = I.commonSettings,
        t = e.enabled,
        r = e.config,
        n = r.mobile,
        i = r.disabledPages
      return (
        !t ||
        !(
          !UserWayWidgetApp.ContextHolder.config.isMobile ||
          !n ||
          n.enabled
        ) ||
        !(
  ...
  try {
    ;(UserWayWidgetApp.setDebugMode = function (e) {
      e
        ? (window.localStorage.setItem('userway-rm-debug', '1'),
          console.log('UserWay Remediation: Debug mode enabled'))
        : window.localStorage.removeItem('userway-rm-debug')
    }),
      (H = window.localStorage.getItem('userway-rm-debug'))
  } catch (e) {}
  var F = {
    ...
    q = M
      ? [
          ...
          'REMEDIATION_MARQUEE',
          'REMEDIATION_SCREEN_READER_BASIC',
          'REMEDIATION_SKIP_NAVIGATION_LINK',
        ]
      : [],
    j = M
      ? [
          ...
          'REMEDIATION_VAGUE_LINK',
          'REMEDIATION_IFRAME_TITLE',
          'REMEDIATION_PDF_DOCUMENTS',
        ].filter(Boolean)
      : [],
    B = M ? ['REMEDIATION_HEADING'] : [],
    G = ['REMEDIATION_COLOR_CONTRAST'],
    V = M
      ? [
          'REMEDIATION_FOCUS_STYLE',
          'REMEDIATION_PER_SITE',
          'REMEDIATION_LABS',
          'REMEDIATION_POPUP',
        ]
      : []
  ;(function () {
    return [932691].includes(
      UserWayWidgetApp.ContextHolder.config.services.siteId
    )
  })() && B.push('REMEDIATION_SOCIAL_SENSITIVITY')
  var Y = [].concat(q, j, B, G),
    K = (function () {
      function r() {}
      return (
        (r.prototype.onHelperRemediationStarted = function (t) {
          e(t)
        }),
        (r.prototype.onHelperRemediationCompleted = function (e) {
          e.backEndData &&
            e.backEndData.items.length &&
            _.sendBackEnd(
              '/remediation/' + e.backEndData.path,
              e.backEndData.items,
              e.backEndData.props
            ),
            N.put(e),
            p(e.helperName, N.getHelperPostMessagePayload(e.helperName)),
            t(e.helperName)
        }),
        r
      )
    })()
  ;(b.HelperCallbackAggregator = new K()),
    (!k ||
      (function () {
        return T.hasAttribute('data-uw-w-kb')
      })() ||
      UserWayWidgetApp.ContextHolder.config.isMobile) &&
      u()
  var X = {
      ...
      'element-is-visible': function (e) {
        ...
        p('element-is-visible', { key: t.key, elements: r })
      },
      'element-highlight': function (e) {
        var t = e.data.data.type,
          r = e.data.data.value ? e.data.data.value.toLowerCase() : '',
          n = Object.assign({ scroll: !0 }, e.data.data.options || {})
        _.highlightElements(t, r, n)
      },
      ...
      'remediation': function (e) {
        var t = e.data.type
        N.get()[t] && p(t, N.getHelperPostMessagePayload(t))
      },
    ...
    $ = {
      'skip-links-get': function (e) {
        p('skip-links-get', J.getSkipLinksConfig())
      },
    ...
    ee = {
      'enable-color-contrast': function () {
        Z.isSmartContrastEnabled() && Z.disableSmartContrast(),
          Z.isEnabled() || (Z.enable(), o())
      },
      'fix-color-contrast': function (e) {
        e.data && e.data.data && (Z.fixIssues(e.data.data), o())
      },
      'fix-all-color-contrast': function () {
        Z.autofixAllIssues(), o()
      },
      'reset-all': function () {
        Z.resetIssuesFixes(), o()
      },
    ...
    ie = function (t) {
      ...
      if (
        r.isUserWay &&
        ('remediation' === r.action || 'aria-editor' === r.action)
      ) {
        var n = t.data.type
  ...
  E.registerPostMessageListener(ie)
})()
